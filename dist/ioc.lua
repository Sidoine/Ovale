...
__exports.IoC = __class(nil, {
    constructor = function(self)
        ...
        self.power = OvalePowerClass(self.debug, self.ovale, self.profiler, self.data, self.future, self.baseState, self.aura, self.paperDoll, self.requirement, self.spellBook)
        ...
        self.frame = OvaleFrameModuleClass(self.state, self.compile, self.future, self.baseState, self.enemies, self.ovale, self.options, self.debug, self.guid, self.spellBook, self.bestAction)
        ...
        self.bossMod = OvaleBossModClass(self.ovale, self.debug, self.profiler, self.future)
