local __exports = LibStub:NewLibrary("ovale/scripts/ovale_priest_spells", 80201)
...
Define(power_word_fortitude 21562)
	SpellAddTargetBuff(power_word_fortitude power_word_fortitude_buff=1)
	SpellRequire(power_word_fortitude unusable 1=buff,power_word_fortitude_buff)
