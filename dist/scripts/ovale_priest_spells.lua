...
# Blasts the enemy with pure Anima, causing (260 of Spell Power) Arcane damage and healing a nearby ally for s2 of the damage done.rnrnGrants s3 lstack:stacks; of Boon of the Ascended.rnrn?c3[|cFFFFFFFFGenerates /100;s4 Insanity.|r]rn][]
  SpellInfo(ascended_blast cd=3 gcd=1 insanity=-600)
Define(ascended_nova 325020)
# Release a powerful burst of anima, dealing (69 of Spell Power) Arcane damage to all enemies and (38 of Spell Power) healing to up to 325041s2 allies within A1 yds.rnrnGrants s3 lstack:stacks; of Boon of the Ascended for each target damaged.
...
# Afflicts the target with a disease that instantly causes (125 of Spell Power) Shadow damage plus an additional o2 Shadow damage over 6 seconds. Heals you for e2*100 of damage dealt.
...
# Corrosive shadow energy radiates from the target, dealing (21.8 of Spell Power)*s2 Shadow damage over 4.5 seconds to all enemies within 49821a2 yards of the target.?s137033[rnrn|cFFFFFFFFGenerates s2*208232s1/100 Insanity over the duration per target hit.|r][]
...
# Instantly deals (75 of Spell Power) Shadow damage to enemies around the target and afflicts them with Shadow Word: Pain. If the enemy is already afflicted by your Shadow Word: Pain, Searing Nightmare's damage is increased by m1.rnrnOnly usable while channeling Mind Sear.
...
# After casting Vampiric Touch on a target, your next Vampiric Touch within 8 seconds is instant cast and deals (155 of Spell Power) Shadow damage immediately.rnrnThis effect cannot occur more than once every 15 seconds.
  SpellInfo(unfurling_darkness_buff duration=8 gcd=0 offgcd=1)
  # Your next Vampiric Touch is instant cast and deals an additional 34914s3 Shadow damage upon application.
...
# Releases an explosive blast of pure void energy, activating Voidform and causing (95 of Spell Power)*2 Shadow damage to all enemies within a1 yds of your target.rnrnDuring Voidform, this ability is replaced by Void Bolt.
...
# Throw a Divine Star forward 24 yds, healing allies in its path for (70 of Spell Power) and dealing (40 of Spell Power) Holy damage to enemies. After reaching its destination, the Divine Star returns to you, healing allies and damaging enemies in its path again.
Define(legacy_of_the_void_talent 20) #21978
# Voidform no longer has a duration, but your Insanity will drain increasingly fast until it reaches 0, causing Voidform to end.rnrnWhile in Voidform, you gain 342855m1 haste every 342855t2 sec and your Void Bolt will also refresh the duration of your Devouring Plague on the target.
