...
Define(mindbender 123040)
	...
	SpellInfo(mindbender add_cd=-40 itemset=T18 itemcount=2 specialization=shadow)
...
Define(power_word_shield 17)
	...
	SpellRequire(power_word_shield cd_percent 0=buff,rapture_buff)
...
Define(shadowfiend 34433)
	...
	SpellInfo(shadowfiend add_cd=-160 itemset=T18 itemcount=2 specialization=shadow)
...
Define(void_eruption 228260)
	SpellInfo(void_eruption insanity=100 shared_cd=void_bolt tag=main)
...
Define(zeks_exterminatus 144438)
Define(zeks_exterminatus_buff 236545)
...
Define(mindbender_talent_discipline 8)
