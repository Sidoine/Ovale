...
Define(arcane_barrage 44425)
	SpellInfo(arcane_barrage cd=3 travel_time=1 haste=spell arcanecharges=finisher)
	SpellAddBuff(arcane_barrage chrono_shift_buff=1 talent=chrono_shift_talent)
Define(arcane_blast 30451)
	...
	SpellAddBuff(arcane_blast rule_of_threes_buff=0 talent=rule_of_threes_talent)
...
Define(arcane_missiles 5143)
	SpellInfo(arcane_missiles duration=2.2 travel_time=1)
	SpellRequire(arcane_missiles unusable 1=buff,!arcane_missiles_buff)
	SpellAddBuff(arcane_missiles arcane_missiles_buff=-1)
	SpellAddBuff(arcane_missiles rule_of_threes_buff=0 talent=rule_of_threes_talent)
...
Define(chrono_shift_buff 236298)
	SpellInfo(chrono_shift_buff duration=5)
...
Define(evocation 12051)
	SpellInfo(evocation cd=90 channel=6)
...
Define(presence_of_mind 205025)
	SpellInfo(presence_of_mind cd=60 gcd=0 max_stacks=2)
...
Define(summon_arcane_familiar 205022)
	...
	SpellAddBuff(summon_arcane_familiar arcane_familiar_buff=1)
