...
Define(arcane_barrage 44425)
	SpellInfo(arcane_barrage cd=3 travel_time=1 arcanecharges=0)
...
Define(expanding_mind_buff 253262)
	SpellInfo(expanding_mind_buff duration=8)
...
Define(phoenixs_flames 194466)
	SpellInfo(phoenixs_flames cd=45 charges=3)
