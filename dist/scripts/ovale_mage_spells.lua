...
Define(fire_blast 108853)
	SpellInfo(fire_blast gcd=0 offgcd=1 cd=12 charges=2)
	SpellInfo(fire_blast cd=10 charges=3 talent=flame_on_talent)
	SpellAddBuff(fire_blast heating_up_buff=1 if_buff=!hot_streak_buff)
	SpellAddBuff(fire_blast hot_streak_buff=1 if_buff=heating_up_buff)
	SpellAddBuff(fire_blast heating_up_buff=0 if_buff=heating_up_buff)
Define(fireball 133)
	SpellInfo(fireball travel_time=1)
	SpellAddBuff(fireball erupting_infernal_core_buff=0)
	SpellAddBuff(fireball heating_up_buff=1 if_buff=!hot_streak_buff)
	SpellAddBuff(fireball heating_up_buff=0 if_buff=heating_up_buff)
	SpellAddBuff(fireball hot_streak_buff=1 if_buff=heating_up_buff)
...
Define(phoenixs_flames 194466)
	SpellAddBuff(phoenixs_flames heating_up_buff=1 if_buff=!hot_streak_buff)
	SpellAddBuff(phoenixs_flames heating_up_buff=0 if_buff=heating_up_buff)
	SpellAddBuff(phoenixs_flames hot_streak_buff=1 if_buff=heating_up_buff)
...
Define(pyroblast 11366)
	...
	SpellAddBuff(pyroblast heating_up_buff=1)
...
Define(rune_of_power 116011)
	...
	SpellInfo(rune_of_power buff_totem=rune_of_power_buff cd=10 duration=180 max_totems=2 totem=1)
