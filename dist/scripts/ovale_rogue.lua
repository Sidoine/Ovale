...
do
    local name = "sc_rogue_assassination_pr"
    local desc = "[8.0] Simulationcraft: Rogue_Assassination_PreRaid"
    local code = [[
...
do
    local name = "sc_rogue_assassination_exsg_pr"
    local desc = "[8.0] Simulationcraft: Rogue_Assassination_PreRaid"
    local code = [[
...
do
    local name = "sc_rogue_outlaw_pr"
    local desc = "[8.0] Simulationcraft: Rogue_Outlaw_PreRaid"
    local code = [[
...
do
    local name = "sc_rogue_outlaw_snd_pr"
    local desc = "[8.0] Simulationcraft: Rogue_Outlaw_PreRaid"
    local code = [[
...
do
    local name = "sc_rogue_subtlety_pr"
    local desc = "[8.0] Simulationcraft: Rogue_Subtlety_PreRaid"
    local code = [[
