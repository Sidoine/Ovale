...
Define(bilescourge_bombers 267211)
	SpellInfo(bilescourge_bombers cd=30 soulshards=2)
...
Define(demonic_core_buff 264173)
	SpellInfo(demonic_core_buff max_stacks=4 duration=20)
...
Define(felguard_felstorm 89751)
	...
	SpellAddPetBuff(felguard_felstorm felguard_felstorm_buff=1)
Define(felguard_felstorm_buff 89751)
	SpellInfo(felguard_felstorm_buff duration=4)
...
Define(grimoire_felguard 111898)
	SpellInfo(grimoire_felguard cd=120 soulshards=1)
Define(shadow_bolt 686)
	SpellInfo(shadow_bolt soulshards=-1)
...
Define(soul_strike 264057)
	SpellInfo(soul_strike cd=10 soulshards=-1)
...
Define(summon_vilefiend 264119)
	SpellInfo(summon_vilefiend cd=45 soulshards=1)
...
Define(wild_imp_id 143622) # Inner Demons talent
Define(dreadstalker 98035)
Define(vile_fiend 135816)
