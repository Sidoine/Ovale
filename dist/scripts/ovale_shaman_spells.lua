...
Define(earth_shock 8042)
	SpellInfo(earth_shock maelstrom=10 max_maelstrom=100)
...
Define(exposed_elements_debuff 252151)
	SpellInfo(exposed_elements_debuff duration=4)
...
Define(flame_shock 188389)
	SpellInfo(flame_shock maelstrom=0 max_maelstrom=20)
...
Define(force_of_the_mountain_buff 254308)
	SpellInfo(force_of_the_mountain_buff duration=10)
...
Define(lava_lash 60103)
	...
	SpellAddTargetDebuff(lava_lash lashing_flames_debuff=1)
Define(lava_surge_buff 77762)
	SpellInfo(lava_surge_buff duration=10)
Define(lashing_flames_debuff 240842)
	SpellInfo(lashing_flames_debuff duration=10)
...
Define(storm_tempests_debuff 214265)
	SpellInfo(storm_tempests_debuff duration=15)
