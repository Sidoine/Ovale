...
AddFunction bloodstandardmainactions
{
 ...
 if runicpower[object Object]() <= 10 spell(death_strike)
 ...
 if { buffremaining(bone_shield) <= timetorunes(3) or buffremaining(bone_shield) <= gcd() + { spellcooldown(blooddrinker) == 0 } * talentpoints(blooddrinker_talent) * 2 or buffstacks(bone_shield) < 3 } and runicpower[object Object]() >= 20 spell(marrowrend)
 ...
 if buffstacks(bone_shield) < 5 and hastalent(ossuary_talent) and runicpower[object Object]() >= 15 spell(marrowrend)
 ...
 if runicpower[object Object]() <= 15 + buffpresent(dancing_rune_weapon) * 5 + enemies() * talentpoints(heartbreaker_talent) * 2 or target.timetodie() < 10 spell(death_strike)
...
{
 unless runicpower[object Object]() <= 10 and spell(death_strike)
 {
  #blooddrinker,if=!buff.dancing_rune_weapon.up
  if not buffpresent(dancing_rune_weapon) spell(blooddrinker)

  unless { buffremaining(bone_shield) <= timetorunes(3) or buffremaining(bone_shield) <= gcd() + { spellcooldown(blooddrinker) == 0 } * talentpoints(blooddrinker_talent) * 2 or buffstacks(bone_shield) < 3 } and runicpower[object Object]() >= 20 and spell(marrowrend) or charges(blood_boil count=0) >= 1.8 and { buffstacks(hemostasis_buff) <= 5 - enemies() or enemies() > 2 } and spell(blood_boil) or buffstacks(bone_shield) < 5 and hastalent(ossuary_talent) and runicpower[object Object]() >= 15 and spell(marrowrend)
  {
   ...
   unless { runicpower[object Object]() <= 15 + buffpresent(dancing_rune_weapon) * 5 + enemies() * talentpoints(heartbreaker_talent) * 2 or target.timetodie() < 10 } and spell(death_strike) or enemies() >= 3 and spell(death_and_decay) or { buffpresent(dancing_rune_weapon) or timetorunes(4) < gcd() } and spell(heart_strike) or buffpresent(dancing_rune_weapon) and spell(blood_boil) or { buffpresent(crimson_scourge) or hastalent(rapid_decomposition_talent) or enemies() >= 2 } and spell(death_and_decay)
   {
    #consumption
    spell(consumption)
   }
...
{
 runicpower[object Object]() <= 10 and spell(death_strike) or { buffremaining(bone_shield) <= timetorunes(3) or buffremaining(bone_shield) <= gcd() + { spellcooldown(blooddrinker) == 0 } * talentpoints(blooddrinker_talent) * 2 or buffstacks(bone_shield) < 3 } and runicpower[object Object]() >= 20 and spell(marrowrend) or charges(blood_boil count=0) >= 1.8 and { buffstacks(hemostasis_buff) <= 5 - enemies() or enemies() > 2 } and spell(blood_boil) or buffstacks(bone_shield) < 5 and hastalent(ossuary_talent) and runicpower[object Object]() >= 15 and spell(marrowrend) or { runicpower[object Object]() <= 15 + buffpresent(dancing_rune_weapon) * 5 + enemies() * talentpoints(heartbreaker_talent) * 2 or target.timetodie() < 10 } and spell(death_strike) or enemies() >= 3 and spell(death_and_decay) or { buffpresent(dancing_rune_weapon) or timetorunes(4) < gcd() } and spell(heart_strike) or buffpresent(dancing_rune_weapon) and spell(blood_boil) or { buffpresent(crimson_scourge) or hastalent(rapid_decomposition_talent) or enemies() >= 2 } and spell(death_and_decay) or spell(blood_boil) or { timetorunes(3) < gcd() or buffstacks(bone_shield) > 6 } and spell(heart_strike)
}

AddFunction bloodstandardcdactions
{
 unless runicpower[object Object]() <= 10 and spell(death_strike) or not buffpresent(dancing_rune_weapon) and spell(blooddrinker) or { buffremaining(bone_shield) <= timetorunes(3) or buffremaining(bone_shield) <= gcd() + { spellcooldown(blooddrinker) == 0 } * talentpoints(blooddrinker_talent) * 2 or buffstacks(bone_shield) < 3 } and runicpower[object Object]() >= 20 and spell(marrowrend) or charges(blood_boil count=0) >= 1.8 and { buffstacks(hemostasis_buff) <= 5 - enemies() or enemies() > 2 } and spell(blood_boil) or buffstacks(bone_shield) < 5 and hastalent(ossuary_talent) and runicpower[object Object]() >= 15 and spell(marrowrend) or runicpower() >= 100 and not buffpresent(dancing_rune_weapon) and spell(bonestorm) or { runicpower[object Object]() <= 15 + buffpresent(dancing_rune_weapon) * 5 + enemies() * talentpoints(heartbreaker_talent) * 2 or target.timetodie() < 10 } and spell(death_strike) or enemies() >= 3 and spell(death_and_decay) or { buffpresent(dancing_rune_weapon) or timetorunes(4) < gcd() } and spell(heart_strike) or buffpresent(dancing_rune_weapon) and spell(blood_boil) or { buffpresent(crimson_scourge) or hastalent(rapid_decomposition_talent) or enemies() >= 2 } and spell(death_and_decay) or spell(consumption) or spell(blood_boil) or { timetorunes(3) < gcd() or buffstacks(bone_shield) > 6 } and spell(heart_strike)
 {
  #use_item,name=grongs_primal_rage
  blooduseitemactions()
  #arcane_torrent,if=runic_power.deficit>20
  if runicpower[object Object]() > 20 spell(arcane_torrent)
 }
}

AddFunction bloodstandardcdpostconditions
{
 runicpower[object Object]() <= 10 and spell(death_strike) or not buffpresent(dancing_rune_weapon) and spell(blooddrinker) or { buffremaining(bone_shield) <= timetorunes(3) or buffremaining(bone_shield) <= gcd() + { spellcooldown(blooddrinker) == 0 } * talentpoints(blooddrinker_talent) * 2 or buffstacks(bone_shield) < 3 } and runicpower[object Object]() >= 20 and spell(marrowrend) or charges(blood_boil count=0) >= 1.8 and { buffstacks(hemostasis_buff) <= 5 - enemies() or enemies() > 2 } and spell(blood_boil) or buffstacks(bone_shield) < 5 and hastalent(ossuary_talent) and runicpower[object Object]() >= 15 and spell(marrowrend) or runicpower() >= 100 and not buffpresent(dancing_rune_weapon) and spell(bonestorm) or { runicpower[object Object]() <= 15 + buffpresent(dancing_rune_weapon) * 5 + enemies() * talentpoints(heartbreaker_talent) * 2 or target.timetodie() < 10 } and spell(death_strike) or enemies() >= 3 and spell(death_and_decay) or { buffpresent(dancing_rune_weapon) or timetorunes(4) < gcd() } and spell(heart_strike) or buffpresent(dancing_rune_weapon) and spell(blood_boil) or { buffpresent(crimson_scourge) or hastalent(rapid_decomposition_talent) or enemies() >= 2 } and spell(death_and_decay) or spell(consumption) or spell(blood_boil) or { timetorunes(3) < gcd() or buffstacks(bone_shield) > 6 } and spell(heart_strike)
}
...
AddFunction blood_defaultcdactions
{
 ...
 unless spell(berserking)
 {
  ...
  if enemies() >= 2 or runecount() < 1 and runicpower[object Object]() > 60 spell(arcane_pulse)
...
AddFunction froststandardmainactions
{
 ...
 if runicpower[object Object]() < 15 + talentpoints(runic_attenuation_talent) * 3 spell(frost_strike)
 ...
 if runicpower[object Object]() > 25 + talentpoints(runic_attenuation_talent) * 3 spell(obliterate)
 #frost_strike
 spell(frost_strike)
}
...
AddFunction frostobliterationmainactions
{
 ...
 if { not buffpresent(rime_buff) or runicpower[object Object]() < 10 or timetorunes(2) > gcd() } and enemies() >= 2 spell(glacial_advance)
 ...
 if { target.debuffstacks(razorice) < 5 or target.debuffremaining(razorice) < 10 } and not buffpresent(rime_buff) or runicpower[object Object]() < 10 or timetorunes(2) > gcd() and not hastalent(frostscythe_talent) spell(frost_strike)
 #frost_strike,if=!buff.rime.up|runic_power.deficit<10|rune.time_to_2>gcd
 if not buffpresent(rime_buff) or runicpower[object Object]() < 10 or timetorunes(2) > gcd() spell(frost_strike)
 #howling_blast,if=buff.rime.up
 if buffpresent(rime_buff) spell(howling_blast)
...
AddFunction frostcooldownscdactions
{
 ...
 unless buffpresent(pillar_of_frost) and spell(berserking)
 {
  ...
  if not buffpresent(pillar_of_frost) and enemies() >= 2 or not buffpresent(pillar_of_frost) and FIXME_rune.deficit >= 5 and runicpower[object Object]() >= 60 spell(arcane_pulse)
  ...
  unless { buffpresent(pillar_of_frost) and { buffremaining(pillar_of_frost) < 5 and hastalent(cold_heart_talent) or not hastalent(cold_heart_talent) and buffremaining(pillar_of_frost) < 3 } and enemies() == 1 or buffpresent(seething_rage) and enemies() == 1 } and spell(bag_of_tricks) or { spellcooldown(empower_rune_weapon) > 0 or hastalent(icecap_talent) } and not buffpresent(pillar_of_frost) and spell(pillar_of_frost)
  {
   ...
   if spellcooldown(pillar_of_frost) == 0 and hastalent(obliteration_talent) and timetorunes(5) > gcd() and runicpower[object Object]() >= 10 or target.timetodie() < 20 spell(empower_rune_weapon)
...
AddFunction frostbos_tickingmainactions
{
 ...
 if { target.debuffstacks(razorice) < 5 or target.debuffremaining(razorice) < 10 } and runicpower[object Object]() > 25 or runecount() > 3 and not hastalent(frostscythe_talent) spell(obliterate)
 #obliterate,if=runic_power.deficit>25|rune>3
 if runicpower[object Object]() > 25 or runecount() > 3 spell(obliterate)
}
...
AddFunction frostbos_tickingshortcdactions
{
 unless { target.debuffstacks(razorice) < 5 or target.debuffremaining(razorice) < 10 } and runicpower() <= 32 and not hastalent(frostscythe_talent) and spell(obliterate) or runicpower() <= 32 and spell(obliterate) or hastalent(gathering_storm_talent) and spell(remorseless_winter) or buffpresent(rime_buff) and spell(howling_blast) or { { target.debuffstacks(razorice) < 5 or target.debuffremaining(razorice) < 10 } and timetorunes(5) < gcd() or runicpower() <= 45 and not hastalent(frostscythe_talent) } and spell(obliterate) or { timetorunes(5) < gcd() or runicpower() <= 45 } and spell(obliterate) or buffpresent(killing_machine_buff) and enemies() >= 2 and spell(frostscythe)
 {
  ...
  if runicpower[object Object]() >= 32 and timetorunes(3) > gcd() spell(horn_of_winter)
 }
}

AddFunction frostbos_tickingshortcdpostconditions
{
 { target.debuffstacks(razorice) < 5 or target.debuffremaining(razorice) < 10 } and runicpower() <= 32 and not hastalent(frostscythe_talent) and spell(obliterate) or runicpower() <= 32 and spell(obliterate) or hastalent(gathering_storm_talent) and spell(remorseless_winter) or buffpresent(rime_buff) and spell(howling_blast) or { { target.debuffstacks(razorice) < 5 or target.debuffremaining(razorice) < 10 } and timetorunes(5) < gcd() or runicpower() <= 45 and not hastalent(frostscythe_talent) } and spell(obliterate) or { timetorunes(5) < gcd() or runicpower() <= 45 } and spell(obliterate) or buffpresent(killing_machine_buff) and enemies() >= 2 and spell(frostscythe) or spell(remorseless_winter) or enemies() >= 2 and spell(frostscythe) or { { target.debuffstacks(razorice) < 5 or target.debuffremaining(razorice) < 10 } and runicpower[object Object]() > 25 or runecount() > 3 and not hastalent(frostscythe_talent) } and spell(obliterate) or { runicpower[object Object]() > 25 or runecount() > 3 } and spell(obliterate)
}

AddFunction frostbos_tickingcdactions
{
 unless { target.debuffstacks(razorice) < 5 or target.debuffremaining(razorice) < 10 } and runicpower() <= 32 and not hastalent(frostscythe_talent) and spell(obliterate) or runicpower() <= 32 and spell(obliterate) or hastalent(gathering_storm_talent) and spell(remorseless_winter) or buffpresent(rime_buff) and spell(howling_blast) or { { target.debuffstacks(razorice) < 5 or target.debuffremaining(razorice) < 10 } and timetorunes(5) < gcd() or runicpower() <= 45 and not hastalent(frostscythe_talent) } and spell(obliterate) or { timetorunes(5) < gcd() or runicpower() <= 45 } and spell(obliterate) or buffpresent(killing_machine_buff) and enemies() >= 2 and spell(frostscythe) or runicpower[object Object]() >= 32 and timetorunes(3) > gcd() and spell(horn_of_winter) or spell(remorseless_winter) or enemies() >= 2 and spell(frostscythe) or { { target.debuffstacks(razorice) < 5 or target.debuffremaining(razorice) < 10 } and runicpower[object Object]() > 25 or runecount() > 3 and not hastalent(frostscythe_talent) } and spell(obliterate) or { runicpower[object Object]() > 25 or runecount() > 3 } and spell(obliterate)
 {
  #arcane_torrent,if=runic_power.deficit>50
  if runicpower[object Object]() > 50 spell(arcane_torrent)
 }
}
...
AddFunction frostbos_poolingmainactions
{
 ...
 if { target.debuffstacks(razorice) < 5 or target.debuffremaining(razorice) < 10 } and runicpower[object Object]() >= 25 and not hastalent(frostscythe_talent) spell(obliterate)
 #obliterate,if=runic_power.deficit>=25
 if runicpower[object Object]() >= 25 spell(obliterate)
 #glacial_advance,if=runic_power.deficit<20&spell_targets.glacial_advance>=2&cooldown.pillar_of_frost.remains>5
 if runicpower[object Object]() < 20 and enemies() >= 2 and spellcooldown(pillar_of_frost) > 5 spell(glacial_advance)
 ...
 if { target.debuffstacks(razorice) < 5 or target.debuffremaining(razorice) < 10 } and runicpower[object Object]() < 20 and not hastalent(frostscythe_talent) and spellcooldown(pillar_of_frost) > 5 spell(frost_strike)
 #frost_strike,if=runic_power.deficit<20&cooldown.pillar_of_frost.remains>5
 if runicpower[object Object]() < 20 and spellcooldown(pillar_of_frost) > 5 spell(frost_strike)
 ...
 if buffpresent(killing_machine_buff) and runicpower[object Object]() > 15 + talentpoints(runic_attenuation_talent) * 3 and enemies() >= 2 spell(frostscythe)
 #frostscythe,if=runic_power.deficit>=(35+talent.runic_attenuation.enabled*3)&spell_targets.frostscythe>=2
 if runicpower[object Object]() >= 35 + talentpoints(runic_attenuation_talent) * 3 and enemies() >= 2 spell(frostscythe)
 ...
 if { target.debuffstacks(razorice) < 5 or target.debuffremaining(razorice) < 10 } and runicpower[object Object]() >= 35 + talentpoints(runic_attenuation_talent) * 3 and not hastalent(frostscythe_talent) spell(obliterate)
 #obliterate,if=runic_power.deficit>=(35+talent.runic_attenuation.enabled*3)
 if runicpower[object Object]() >= 35 + talentpoints(runic_attenuation_talent) * 3 spell(obliterate)
 ...
 if spellcooldown(pillar_of_frost) > timetorunes(4) and runicpower[object Object]() < 40 and enemies() >= 2 spell(glacial_advance)
 ...
 if { target.debuffstacks(razorice) < 5 or target.debuffremaining(razorice) < 10 } and spellcooldown(pillar_of_frost) > timetorunes(4) and runicpower[object Object]() < 40 and not hastalent(frostscythe_talent) spell(frost_strike)
 #frost_strike,if=cooldown.pillar_of_frost.remains>rune.time_to_4&runic_power.deficit<40
 if spellcooldown(pillar_of_frost) > timetorunes(4) and runicpower[object Object]() < 40 spell(frost_strike)
}
...
{
 buffpresent(rime_buff) and spell(howling_blast) or { target.debuffstacks(razorice) < 5 or target.debuffremaining(razorice) < 10 } and runicpower[object Object]() >= 25 and not hastalent(frostscythe_talent) and spell(obliterate) or runicpower[object Object]() >= 25 and spell(obliterate) or runicpower[object Object]() < 20 and enemies() >= 2 and spellcooldown(pillar_of_frost) > 5 and spell(glacial_advance) or { target.debuffstacks(razorice) < 5 or target.debuffremaining(razorice) < 10 } and runicpower[object Object]() < 20 and not hastalent(frostscythe_talent) and spellcooldown(pillar_of_frost) > 5 and spell(frost_strike) or runicpower[object Object]() < 20 and spellcooldown(pillar_of_frost) > 5 and spell(frost_strike) or buffpresent(killing_machine_buff) and runicpower[object Object]() > 15 + talentpoints(runic_attenuation_talent) * 3 and enemies() >= 2 and spell(frostscythe) or runicpower[object Object]() >= 35 + talentpoints(runic_attenuation_talent) * 3 and enemies() >= 2 and spell(frostscythe) or { target.debuffstacks(razorice) < 5 or target.debuffremaining(razorice) < 10 } and runicpower[object Object]() >= 35 + talentpoints(runic_attenuation_talent) * 3 and not hastalent(frostscythe_talent) and spell(obliterate) or runicpower[object Object]() >= 35 + talentpoints(runic_attenuation_talent) * 3 and spell(obliterate) or spellcooldown(pillar_of_frost) > timetorunes(4) and runicpower[object Object]() < 40 and enemies() >= 2 and spell(glacial_advance) or { target.debuffstacks(razorice) < 5 or target.debuffremaining(razorice) < 10 } and spellcooldown(pillar_of_frost) > timetorunes(4) and runicpower[object Object]() < 40 and not hastalent(frostscythe_talent) and spell(frost_strike) or spellcooldown(pillar_of_frost) > timetorunes(4) and runicpower[object Object]() < 40 and spell(frost_strike)
}
...
AddFunction frostaoemainactions
{
 ...
 if runicpower[object Object]() < 15 + talentpoints(runic_attenuation_talent) * 3 spell(glacial_advance)
 ...
 if { target.debuffstacks(razorice) < 5 or target.debuffremaining(razorice) < 10 } and runicpower[object Object]() < 15 + talentpoints(runic_attenuation_talent) * 3 and not hastalent(frostscythe_talent) spell(frost_strike)
 #frost_strike,if=runic_power.deficit<(15+talent.runic_attenuation.enabled*3)&!talent.frostscythe.enabled
 if runicpower[object Object]() < 15 + talentpoints(runic_attenuation_talent) * 3 and not hastalent(frostscythe_talent) spell(frost_strike)
 #remorseless_winter
 spell(remorseless_winter)
 #frostscythe
 spell(frostscythe)
 ...
 if { target.debuffstacks(razorice) < 5 or target.debuffremaining(razorice) < 10 } and runicpower[object Object]() > 25 + talentpoints(runic_attenuation_talent) * 3 and not hastalent(frostscythe_talent) spell(obliterate)
 #obliterate,if=runic_power.deficit>(25+talent.runic_attenuation.enabled*3)
 if runicpower[object Object]() > 25 + talentpoints(runic_attenuation_talent) * 3 spell(obliterate)
 #glacial_advance
