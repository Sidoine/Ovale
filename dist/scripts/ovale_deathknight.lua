...
do
    ...
    local desc = "[8.2] Simulationcraft: T24_Death_Knight_Blood"
    local code = [[
...
do
    ...
    local desc = "[8.2] Simulationcraft: T24_Death_Knight_Frost"
    local code = [[
...
do
    ...
    local desc = "[8.2] Simulationcraft: T24_Death_Knight_Unholy"
    local code = [[
