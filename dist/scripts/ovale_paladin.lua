...
do
    local name = "sc_paladin_protection_pr"
    local desc = "[8.0] Simulationcraft: Paladin_Protection_PreRaid"
    local code = [[
...
do
    local name = "sc_paladin_retribution_pr"
    local desc = "[8.0] Simulationcraft: Paladin_Retribution_PreRaid"
    local code = [[
