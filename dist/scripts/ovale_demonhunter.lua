...
do
    local name = "sc_demon_hunter_havoc_pr"
    local desc = "[8.0] Simulationcraft: Demon_Hunter_Havoc_PreRaid"
    local code = [[
...
do
    local name = "sc_demon_hunter_vengeance_pr"
    local desc = "[8.0] Simulationcraft: Demon_Hunter_Vengeance_PreRaid"
    local code = [[
