...
do
    ...
    local desc = "[8.2] Simulationcraft: T24_Hunter_Beast_Mastery"
    local code = [[
...
do
    ...
    local desc = "[8.2] Simulationcraft: T24_Hunter_Marksmanship"
    local code = [[
...
do
    ...
    local desc = "[8.2] Simulationcraft: T24_Hunter_Survival"
    local code = [[
