...
AddFunction marksmanshiptrickshotsmainactions
{
 ...
 if buffexpires(trick_shots_buff) or buffpresent(precise_shots_buff) and not buffpresent(trueshot) or focus() > 70 spell(multishot_marksmanship)
 #concentrated_flame
 spell(concentrated_flame)
