...
AddFunction enhancementprecombatmainactions
{
 ...
 #lightning_shield
 if buffexpires(lightning_shield_unused_1) spell(lightning_shield)
 #windfury_totem
...
{
 unless spell(windfury_weapon) or buffexpires(flametongue_weapon) and spell(flametongue_weapon) or buffexpires(lightning_shield_unused_1) and spell(lightning_shield)
 {
  #stormkeeper,if=talent.stormkeeper.enabled
...
{
 spell(windfury_weapon) or buffexpires(flametongue_weapon) and spell(flametongue_weapon) or buffexpires(lightning_shield_unused_1) and spell(lightning_shield) or spell(windfury_totem)
}
...
{
 spell(windfury_weapon) or buffexpires(flametongue_weapon) and spell(flametongue_weapon) or buffexpires(lightning_shield_unused_1) and spell(lightning_shield) or hastalent(stormkeeper_talent_enhancement) and spell(stormkeeper_enhancement) or spell(windfury_totem)
}
