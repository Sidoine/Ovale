...
do
    ...
    local desc = "[8.2] Simulationcraft: T24_Warlock_Affliction"
    local code = [[
...
do
    ...
    local desc = "[8.2] Simulationcraft: T24_Warlock_Demonology"
    local code = [[
...
do
    ...
    local desc = "[8.2] Simulationcraft: T24_Warlock_Destruction"
    local code = [[
