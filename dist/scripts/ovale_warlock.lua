...
do
    local name = "pr_warlock_affliction"
    local desc = "[8.0] Simulationcraft: Warlock_Affliction"
    local code = [[
...
do
    local name = "pr_warlock_demonology"
    local desc = "[8.0] Simulationcraft: Warlock_Demonology"
    local code = [[
...
do
    local name = "pr_warlock_destruction"
    local desc = "[8.0] Simulationcraft: Warlock_Destruction"
    local code = [[
