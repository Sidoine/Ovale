...
Define(avenging_wrath_heal_buff 31882)
	...
	SpellInfo(avenging_wrath_heal_buff add_duration=5 talent=sanctified_wrath_talent)
...
Define(blade_of_justice 184575)
	SpellInfo(blade_of_justice holypower=-2 cd=10.5)
...
Define(divine_hammer 198034)
	SpellInfo(divine_hammer cd=12 holypower=-2)
	SpellInfo(divine_hammer add_holypower=-1 itemset=T20 itemcount=2)
...
Define(divine_storm 53385)
	...
	SpellRequire(divine_storm holypower_percent 0=buff,divine_storm_no_holypower_buff)
...
SpellList(divine_storm_no_holypower_buff divine_crusader_buff divine_purpose_buff)
Define(execution_sentence 213757)
	SpellInfo(execution_sentence cd=20 holypower=3)
...
Define(hammer_of_the_righteous 53595)
	SpellInfo(hammer_of_the_righteous holypower=-1 cd=4.5)
...
Define(holypower_avenger 105809)
	SpellInfo(holypower_avenger cd=90)
	SpellAddBuff(holypower_avenger holypower_avenger_buff=1)
Define(holypower_avenger_buff 105809)
	SpellInfo(holypower_avenger_buff duration=20)
Define(holypower_light 82326)
	SpellAddBuff(holypower_light infusion_of_light_buff=-1)
Define(holypower_prism 114165)
	SpellInfo(holypower_prism cd=20)
Define(holypower_shock 20473)
	SpellInfo(holypower_shock cd=6 cd_haste=melee)
	SpellRequire(holypower_shock cd 3=buff,avenging_wrath_heal_buff talent=sanctified_wrath_talent)
Define(holypower_wrath 210220)
	SpellInfo(holypower_wrath cd=180)
...
Define(judgment 20271)
	...
	SpellInfo(judgment cd_haste=melee specialization=!holypower)
	SpellInfo(judgment cd_haste=spell specialization=holypower)
	SpellInfo(judgment holypower=-1 specialization=retribution)
	...
	SpellAddTargetDebuff(judgment judgment_holypower_debuff=1 specialization=holypower)
	SpellAddTargetDebuff(judgment judgement_of_light_debuff=40 if_spell=judgment_of_light)
Define(judgment_holypower_debuff 214222)
	SpellInfo(judgment_holypower_debuff duration=6)
...
SpellList(light_of_dawn_no_holypower_buff divine_purpose_buff lights_favor_buff)
...
Define(templars_verdict 85256)
	...
	SpellRequire(templars_verdict add_holypower -1=buff,the_fires_of_justice_buff talent=the_fires_of_justice_talent)
...
Define(word_of_glory 85673)
	...
	SpellRequire(word_of_glory holypower_percent 0=buff,word_of_glory_no_holypower_buff)
	...
	SpellAddBuff(word_of_glory lawful_words_buff=0 itemset=T17 itemcount=4 specialization=holypower)
SpellList(word_of_glory_no_holypower_buff bastion_of_power_buff divine_purpose_buff lawful_words_buff)
Define(zeal 217020)
