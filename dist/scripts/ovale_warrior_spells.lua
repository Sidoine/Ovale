...
Define(execute_arms 163201)
	...
	SpellRequire(execute_arms target_health_pct 100=buff,stone_heart_buff specialization=arms)
...
Define(execute 5308)
	...
	SpellRequire(execute target_health_pct 100=buff,stone_heart_buff specialization=fury)
...
Define(rampage 184367)
	...
	SpellAddBuff(rampage frothing_berserker_buff=1)
