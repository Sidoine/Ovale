...
do
    local name = "sc_mage_arcane_pr"
    local desc = "[8.0] Simulationcraft: Mage_Arcane_PreRaid"
    local code = [[
...
do
    local name = "sc_mage_fire_pr"
    local desc = "[8.0] Simulationcraft: Mage_Fire_PreRaid"
    local code = [[
...
do
    local name = "sc_mage_frost_pr"
    local desc = "[8.0] Simulationcraft: Mage_Frost_PreRaid"
    local code = [[
