...
AddFunction prepull_evo
{
 ...
 } == 0 and equippedruneforge(siphon_storm_runeforge) and covenant(night_fae) 1
 if 
 {
  if 0 == 0 and equippedruneforge(siphon_storm_runeforge) and enemies() > 2 1
 } == 0 and equippedruneforge(siphon_storm_runeforge) and covenant(necrolord) and enemies() > 1 1
 if 0 == 0 and equippedruneforge(siphon_storm_runeforge) and enemies() > 2 1
}
