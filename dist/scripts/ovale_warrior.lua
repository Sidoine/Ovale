local __exports = LibStub:NewLibrary("ovale/scripts/ovale_warrior", 90000)
...
AddFunction armsexecutemainactions
{
 ...
 if buffpresent(crushing_assault_buff) and buffexpires(memory_of_lucid_dreams_buff) spell(slam)
 #overpower
 spell(overpower)
 #execute
 spell(execute)
