...
Define(blackout_kick 100784)
	...
	SpellAddTargetDebuff(blackout_kick mark_of_the_crane_debuff=1 specialization=windwalker)
...
SpellList(breath_of_fire_dot_debuff breath_of_fire_debuff)
...
Define(energizing_elixir 115288)
	SpellInfo(energizing_elixir chi=refill energy=refill cd=60 gcd=0 offgcd=1)
...
SpellList(invoke_niuzao_the_black_ox invoke_niuzao)
...
SpellList(brews ironskin_brew purifying_brew)
