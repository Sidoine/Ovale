...
AddFunction brewmaster_defaultmainactions
{
 ...
 if staggerremaining() / maxhealth() * 100 > 18 spell(purifying_brew)
 #purifying_brew,if=stagger.pct>9&stagger.amounttototalpct>53
 if staggerremaining() / maxhealth() * 100 > 9 and message("stagger.amounttototalpct is not implemented") > 53 spell(purifying_brew)
 #purifying_brew,if=stagger.pct>4.5&stagger.amounttototalpct>71
 if staggerremaining() / maxhealth() * 100 > 4.5 and message("stagger.amounttototalpct is not implemented") > 71 spell(purifying_brew)
 #purifying_brew,if=stagger.pct>3&stagger.amounttototalpct>80
 if staggerremaining() / maxhealth() * 100 > 3 and message("stagger.amounttototalpct is not implemented") > 80 spell(purifying_brew)
...
AddFunction brewmaster_defaultshortcdactions
{
 ...
 unless incomingdamage(1.5) > 0 and buffexpires(fortifying_brew_buff) and spell(dampen_harm) or spell(berserking)
 {
  ...
  unless staggerremaining() / maxhealth() * 100 > 18 and spell(purifying_brew) or staggerremaining() / maxhealth() * 100 > 9 and message("stagger.amounttototalpct is not implemented") > 53 and spell(purifying_brew) or staggerremaining() / maxhealth() * 100 > 4.5 and message("stagger.amounttototalpct is not implemented") > 71 and spell(purifying_brew) or staggerremaining() / maxhealth() * 100 > 3 and message("stagger.amounttototalpct is not implemented") > 80 and spell(purifying_brew) or spellcharges(purifying_brew count=0) < 0.5 and spell(black_ox_brew) or energy() + energyregenrate() * spellcooldown(keg_smash) < 40 and buffexpires(blackout_combo_buff) and not spellcooldown(keg_smash) > 0 and spell(black_ox_brew) or enemies() >= 2 and spell(keg_smash)
  {
   ...
   if buffexpires(blackout_combo_buff) and incomingdamage(1.999) > maxhealth() * 0.1 + staggertick(4) and buffstacks(elusive_brawler) < 2 spell(celestial_brew)
  }
 }
}
