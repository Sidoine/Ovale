...
do
    ...
    local desc = "[8.2] Simulationcraft: T24_Monk_Brewmaster"
    local code = [[
...
do
    ...
    local desc = "[8.2] Simulationcraft: T24_Monk_Windwalker"
    local code = [[
...
do
    ...
    local desc = "[8.2] Simulationcraft: T24_Monk_Windwalker_Serenity"
    local code = [[
