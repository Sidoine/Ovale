...
local OvaleFrame = __class(AceGUI.WidgetContainerBase, {
    ...
    OnUpdate = function(self, elapsed)
        ...
        local refresh = OvaleDebug.trace or (self.visible or (Ovale.db.profile.apparence.spellFlash.enabled and OvaleSpellFlash)) and (self.timeSinceLastUpdate > Ovale.db.profile.apparence.minFrameRefresh / 1000 and next(Ovale.refreshNeeded) or self.timeSinceLastUpdate > Ovale.db.profile.apparence.maxFrameRefresh / 1000)
        if refresh then
