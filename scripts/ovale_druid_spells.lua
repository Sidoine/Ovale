...
Define(brutal_slash 202028)
	...
	SpellInfo(brutal_slash buff_energy=incarnation_king_of_the_jungle_buff buff_energy_amount=-12)
...
Define(ferocious_bite 22568)
	...
	SpellInfo(ferocious_bite buff_energy=incarnation_king_of_the_jungle_buff buff_energy_amount=-15)
...
Define(maim 22570)
	...
	SpellInfo(maim buff_energy=incarnation_king_of_the_jungle_buff buff_energy_amount=-21)
Define(mangle 33917)
...
Define(rake 1822)
	...
	SpellInfo(rake buff_energy=incarnation_king_of_the_jungle_buff buff_energy_amount=-21)
...
Define(rip 1079)
	...
	SpellInfo(rip buff_energy=incarnation_king_of_the_jungle_buff buff_energy_amount=-18)
...
Define(savage_roar 52610)
	...
	SpellInfo(savage_roar buff_energy=incarnation_king_of_the_jungle_buff buff_energy_amount=-24)
...
Define(shred 5221)
	...
	SpellInfo(shred buff_energy=incarnation_king_of_the_jungle_buff buff_energy_amount=-24)
...
Define(swipe_cat 106785) # Artifact will reduce energy cost by 2 for every target with thrash_cat_debuff
	...
	SpellInfo(swipe_cat buff_energy=incarnation_king_of_the_jungle_buff buff_energy_amount=-27)
...
Define(thrash_cat 106830)
	...
	SpellInfo(thrash_cat buff_energy=incarnation_king_of_the_jungle_buff buff_energy_amount=-30)
