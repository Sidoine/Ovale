...
Define(ferocious_bite 22568)
	...
	SpellRequire(ferocious_bite energy 0=buff,clearcasting_buff if_spell=omen_of_clarity)
	SpellRequire(ferocious_bite energy -25=buff,clearcasting_buff if_spell=omen_of_clarity itemset=T18 itemcount=4 specialization=feral)
	SpellAddBuff(ferocious_bite bloodtalons_buff=-1 talent=bloodtalons_talent)
	SpellAddBuff(ferocious_bite clearcasting_buff=-1 if_spell=omen_of_clarity)
...
Define(healing_touch 5185)
	...
	SpellAddBuff(healing_touch bloodtalons_buff=1 talent=bloodtalons_talent specialization=feral)
	SpellInfo(healing_touch gcd_haste=spell if_buff=predatory_swiftness_buff)
...
Define(lunar_strike_balance 194153)
	SpellInfo(lunar_strike_balance astralpower=-10 astralpower_more50=celestial_alignment_buff astralpower_more40=blessing_of_elune_buff)
...
Define(maim 22570)
	...
	SpellRequire(maim energy 0=buff,clearcasting_buff if_spell=omen_of_clarity)
Define(mangle 33917)
...
Define(rake 1822)
	...
	SpellRequire(rake energy 0=buff,clearcasting_buff if_spell=omen_of_clarity)
	SpellAddBuff(rake bloodtalons_buff=-1 talent=bloodtalons_talent)
	SpellAddBuff(rake clearcasting_buff=-1 if_spell=omen_of_clarity)
...
Define(rip 1079)
	...
	SpellRequire(rip energy 0=buff,clearcasting_buff if_spell=omen_of_clarity)
...
Define(savage_roar 52610)
	...
	SpellRequire(savage_roar energy 0=buff,clearcasting_buff if_spell=omen_of_clarity)
	SpellAddBuff(savage_roar clearcasting_buff=-1 if_spell=omen_of_clarity)
