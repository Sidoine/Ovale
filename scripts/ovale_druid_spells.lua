...
SpellList(improved_rake_buff king_of_the_jungle_buff prowl_aura shadowmeld_buff)
...
Define(prowl 5215)
	...
	SpellAddBuff(prowl prowl_aura=1)
Define(prowl_aura 5215)
SpellList(prowl_buff king_of_the_jungle_buff prowl_aura)
