...
Define(frenzied_regeneration 22842)
	...
	SpellAddBuff(frenzied_regeneration primal_mending_buff=0 itemset=T17 itemcount=4)
...
Define(natures_swiftness 132158)
	...
	SpellAddBuff(natures_swiftness natures_swiftness_buff=3 itemset=T17 itemcount=2)
Define(natures_swiftness_buff 132158)
	SpellInfo(natures_swiftness_buff max_stacks=3 itemset=T17 itemcount=2)
