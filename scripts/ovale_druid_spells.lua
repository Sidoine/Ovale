...
Define(brutal_slash 202028)
	...
	SpellRequire(brutal_slash energy_percent 60=buff,incarnation_king_of_the_jungle_buff)
...
Define(ferocious_bite 22568)
	...
	SpellRequire(ferocious_bite energy_percent 60=buff,incarnation_king_of_the_jungle_buff)
...
Define(maim 22570)
	...
	SpellRequire(maim energy_percent 60=buff,incarnation_king_of_the_jungle_buff)
Define(mangle 33917)
...
Define(rake 1822)
	...
	SpellRequire(rake energy_percent 60=buff,incarnation_king_of_the_jungle_buff)
...
Define(rip 1079)
	...
	SpellRequire(rip energy_percent 60=buff,incarnation_king_of_the_jungle_buff)
...
Define(shred 5221)
	...
	SpellRequire(shred energy_percent 60=buff,incarnation_king_of_the_jungle_buff)
...
Define(solar_wrath 190984)
	SpellInfo(solar_wrath travel_time=1 astralpower=-10)
...
Define(starsurge_moonkin 78674)
	...
	SpellInfo(starsurge_moonkin addastralpower=-10 talent=soul_of_the_forest_talent)
	SpellAddBuff(starsurge lunar_empowerment_buff=1)
	SpellAddBuff(starsurge solar_empowerment_buff=1)
...
Define(swipe_cat 106785) # Artifact will reduce energy cost by 2 for every target with thrash_cat_debuff
	...
	SpellRequire(swipe_cat energy_percent 60=buff,incarnation_king_of_the_jungle_buff)
...
Define(thrash_cat 106830)
	...
	SpellRequire(thrash_cat energy_percent 60=buff,incarnation_king_of_the_jungle_buff)
