...
Define(ferocious_bite 22568)
	...
	SpellAddTargetBuff(ferocious_bite rip_debuff=refresh,target_health_pct,25 if_spell=rip)
...
Define(moonfire 8921)
	SpellInfo(moonfire combo=1 energy=30 if_stance=druid_cat_form if_spell=lunar_inspirations)
