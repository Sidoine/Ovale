...
Define(frenzied_regeneration 22842)
	SpellInfo(frenzied_regeneration cd=1.5 max_rage=60 rage=finisher stance=druid_bear_form)
...
Define(heart_of_the_wild_tank 108293)
	SpellInfo(heart_of_the_wild_tank cd=360)
...
Define(maul 6807)
	SpellInfo(maul cd=3 rage=20 stance=druid_bear_form)
...
Define(rake_debuff 155722)
	...
	SpellDamageBuff(rake_debuff prowl_buff=2 if_spell=improved_rake)
	SpellDamageBuff(rake_debuff shadowmeld_buff=2 if_spell=improved_rake)
...
Define(savage_defense 62606)
	SpellInfo(savage_defense rage=60 stance=druid_bear_form)
...
Define(tigers_fury 5217)
	SpellInfo(tigers_fury cd=30 energy=-60 stance=druid_cat_form)
