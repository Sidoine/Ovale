...
Define(cat_form 768)
	...
	SpellInfo(cat_form unusable=1 if_spell=claws_of_shirvallah)
...
Define(rake 1822)
	...
	SpellAddBuff(rake savage_roar_glyph_of_savage_roar_buff=1,buff,prowl_buff glyph=glyph_of_savage_roar)
...
Define(shred 5221)
	...
	SpellAddBuff(shred savage_roar_glyph_of_savage_roar_buff=1,buff,prowl_buff glyph=glyph_of_savage_roar)
