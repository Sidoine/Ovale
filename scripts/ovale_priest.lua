...
AddFunction ShadowCopShortCdActions
{
		...
		or BuffStacks(shadow_word_death_reset_cooldown_buff) == 0 and Spell(shadow_word_death)
	{
		...
		unless DebuffCountOnAny(shadow_word_pain_debuff) <= Enemies() and DebuffCountOnAny(shadow_word_pain_debuff) <= 5 and True(miss_react) and not target.DebuffPresent(shadow_word_pain_debuff) and 0 == 0 and Spell(shadow_word_pain)
			or DebuffCountOnAny(vampiric_touch_debuff) <= Enemies() and DebuffCountOnAny(vampiric_touch_debuff) <= 5 and target.DebuffRemaining(vampiric_touch_debuff) < CastTime(vampiric_touch) and True(miss_react) and 0 == 0 and Spell(vampiric_touch)
			or Enemies() >= 3 and Spell(mind_sear)
			or Enemies() <= 8 and BuffPresent(surge_of_darkness_buff) and Spell(mind_spike)
			or Enemies() >= 3 and Spell(mind_sear)
...
AddFunction ShadowCopAdvancedMfiShortCdActions
{
		...
		or BuffStacks(shadow_word_death_reset_cooldown_buff) == 0 and Spell(shadow_word_death)
	{
		...
		unless DebuffCountOnAny(shadow_word_pain_debuff) <= Enemies() and DebuffCountOnAny(shadow_word_pain_debuff) <= 5 and target.DebuffRemaining(shadow_word_pain_debuff) < 18 * 0.3 and True(miss_react) and 0 == 0 and Spell(shadow_word_pain)
			or DebuffCountOnAny(vampiric_touch_debuff) <= Enemies() and DebuffCountOnAny(vampiric_touch_debuff) <= 5 and target.DebuffRemaining(vampiric_touch_debuff) < 15 * 0.3 + CastTime(vampiric_touch) and True(miss_react) and 0 == 0 and Spell(vampiric_touch)
...
AddFunction ShadowMainShortCdActions
{
		...
		or Enemies() <= 2 and BuffPresent(shadow_word_insanity_buff) and Spell(insanity)
	{
		...
		unless Talent(auspicious_spirits_talent) and target.DebuffRemaining(shadow_word_pain_debuff) < 18 * 0.3 and True(miss_react) and Spell(shadow_word_pain)
			or DebuffCountOnAny(shadow_word_pain_debuff) <= Enemies() and DebuffCountOnAny(shadow_word_pain_debuff) <= 5 and not Talent(auspicious_spirits_talent) and target.DebuffRemaining(shadow_word_pain_debuff) < 18 * 0.3 and True(miss_react) and Spell(shadow_word_pain)
			or DebuffCountOnAny(vampiric_touch_debuff) <= Enemies() and DebuffCountOnAny(vampiric_touch_debuff) <= 5 and target.DebuffRemaining(vampiric_touch_debuff) < 15 * 0.3 + CastTime(vampiric_touch) and True(miss_react) and Spell(vampiric_touch)
