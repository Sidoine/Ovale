...
AddFunction CombatDefaultCdActions
{
	...
	{
		#call_action_list,name=adrenaline_rush,if=buff.bloodlust.up|cooldown.killing_spree.remains>10
		if BuffPresent(burst_haste_buff any=1) or SpellCooldown(killing_spree) > 10 CombatAdrenalineRushCdActions()
