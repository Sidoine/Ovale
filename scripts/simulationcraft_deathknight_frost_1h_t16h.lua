...
AddFunction FrostSingleTargetActions
{
	...
	if Talent(blood_tap_talent) and BuffStacks(blood_charge_buff) > 10 and { RunicPower() > 76 or RunicPower() >= 20 and BuffPresent(killing_machine_buff) } and BuffStacks(blood_charge_buff) >= 5 Spell(blood_tap)
