...
Define(enveloping_mist_buff 124682)
	SpellInfo(enveloping_mist_buff duration=6 tick=1)
	SpellInfo(enveloping_mist_buff duration=7 tick=1 talent=mist_wrap_talent)
Define(essence_font 191837)
	SpellInfo(essence_font cd=12)
...
Define(zen_pulse 124081)
	SpellInfo(zen_pulse cd=15)
