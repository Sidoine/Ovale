...
Define(blackout_kick 100784)
	...
	SpellRequire(blackout_kick chi 0=buff,blackout_kick_no_chi_buff)
...
Define(fists_of_fury 113656)
	...
	SpellAddBuff(fists_of_fury tigereye_brew_buff=1 if_spell=tigereye_brew itemset=T17 itemcount=2)
...
Define(purifying_brew 119582)
	...
	SpellRequire(purifying_brew chi 0=buff,purifying_brew_no_chi_buff)
	SpellAddBuff(purifying_brew elusive_brew_stacks_buff=1 if_spell=elusive_brew itemset=T17 itemcount=4)
...
Define(surging_mist 116694)
	...
	SpellRequire(surging_mist chi -2=buff,vital_mists_buff,5 itemset=T17 itemset=2)
...
Define(surging_mist_glyphed 123273)
	...
	SpellRequire(surging_mist_glyphed chi -2=buff,vital_mists_buff,5 itemset=T17 itemset=2)
...
Define(thunder_focus_tea 116680)
	...
	SpellRequire(thunder_focus_tea chi 1=buff,chi_jis_guidance_buff itemset=T17 itemcount=4)
	SpellAddBuff(thunder_focus_tea chi_jis_guidance_buff=-1 itemset=T17 itemcount=4)
...
Define(tiger_palm 100787)
	...
	SpellRequire(tiger_palm chi 0=buff,tiger_palm_no_chi_buff if_stance=monk_stance_of_the_fierce_tiger)
