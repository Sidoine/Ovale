...
Define(keg_smash 121253)
	...
	SpellAddTargetBuff(keg_smash keg_smash_debuff=1)
...
Define(leg_sweep 119381)
	...
	SpellAddTargetBuff(leg_sweep leg_sweep_debuff=1)
...
Define(rising_sun_kick 107428)
	...
	SpellAddTargetBuff(rising_sun_kick rising_fist_debuff=1 itemset=T20 itemcount=2)
...
Define(touch_of_death 115080)
	...
	SpellAddTargetBuff(touch_of_death touch_of_death_debuff=1)
