...
Define(fists_of_fury 113656)
	...
	SpellInfo(fists_of_fury chi=2 if_equipped=katsuos_eclipse_item)
...
Define(leg_sweep 119381)
	...
	SpellAddDebuff(leg_sweep leg_sweep_debuff=1)
...
Define(rising_sun_kick 107428)
	...
	SpellAddDebuff(rising_sun_kick rising_fist_debuff=1  itemset=T20 itemcount=2)
...
Define(touch_of_death 115080)
	...
	SpellAddDebuff(touch_of_death touch_of_death_debuff=1)
