...
Define(aspect_of_the_eagle 186289)
	...
	SpellInfo(aspect_of_the_eagle cd=78 if_equipped=call_of_the_wild)
...
Define(aspect_of_the_wild 193530)
	...
	SpellInfo(aspect_of_the_wild cd=78 if_equipped=call_of_the_wild)
...
Define(cobra_shot 193455)
	...
	SpellInfo(cobra_shot addfocus=-2 pertrait=slithering_serpents_trait)
Define(counter_shot 147362)
	SpellInfo(counter_shot cd=24)
Define(dire_beast 120679)
	SpellInfo(dire_beast cd=12 charges=2 cd_haste=ranged)
	SpellInfo(dire_beast charges=3 if_equipped=the_mantle_of_command)
	SpellInfo(dire_beast replace=dire_frenzy talent=dire_frenzy_talent)
...
Define(dire_frenzy 217200)
	SpellInfo(dire_frenzy cd=12 charges=2 cd_haste=ranged)
...
Define(slithering_serpents_trait 238051)
