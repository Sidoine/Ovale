...
Define(dire_beast 120679)
	SpellInfo(dire_beast cd=12 cd_haste=ranged charges=1)
	SpellInfo(dire_beast charges=2 if_equipped=the_mantle_of_command)
...
Define(dire_frenzy 217200)
	SpellInfo(dire_frenzy cd=12 focus=-25 charges=1)
	SpellInfo(dire_frenzy charges=2 if_equipped=the_mantle_of_command)
