...
do
	...
	local code = [[
# Based on SimulationCraft profile "Warlock_Demonology_T20M".
#    class=warlock
#    spec=demonology
#    talents=1202023
#    pet=felguard
...
AddFunction DemonologyDefaultMainActions
{
    ...
    if SoulShards() >= 4 and { not { no_de1() or PreviousGCDSpell(hand_of_guldan) } and { pet_count() >= 13 and not Talent(shadowy_inspiration_talent) or pet_count() >= 6 and Talent(shadowy_inspiration_talent) } or not no_de2() or SoulShards() == 5 } and Talent(power_trip_talent) Spell(hand_of_guldan)
