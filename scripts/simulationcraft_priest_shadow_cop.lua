...
do
	...
	local desc = "[6.1] SimulationCraft: Priest_Shadow_T17M_COP"
	local code = [[
...
AddFunction ShadowCopDotweaveMainActions
{
	...
	#searing_insanity,if=buff.insanity.remains<0.5*gcd&active_enemies>=3&cooldown.mind_blast.remains>0.5*gcd,chain=1,interrupt_if=(cooldown.mind_blast.remains<=0.1|cooldown.shadow_word_death.remains<=0.1)
...
{
	unless target.DebuffPresent(vampiric_touch_debuff) and target.DebuffPresent(shadow_word_pain_debuff) and ShadowOrbs() == 5 and not SpellCooldown(devouring_plague) > 0 and Spell(devouring_plague) or BuffRemaining(mental_instinct_buff) < GCD() and BuffRemaining(mental_instinct_buff) > GCD() * 0.7 and BuffPresent(mental_instinct_buff) and Spell(devouring_plague) or target.DebuffPresent(vampiric_touch_debuff) and target.DebuffPresent(shadow_word_pain_debuff) and not BuffPresent(insanity_buff) and SpellCooldown(mind_blast) > 0.4 * GCD() and Spell(devouring_plague) or target.HealthPercent() < 20 and not target.DebuffPresent(shadow_word_pain_debuff) and not target.DebuffPresent(vampiric_touch_debuff) and Spell(shadow_word_death) or target.HealthPercent() < 20 and Spell(shadow_word_death) or Glyph(glyph_of_mind_harvest) and target.MindHarvest() == 0 and ShadowOrbs() <= 2 and Spell(mind_blast) or ShadowOrbs() <= 4 and not SpellCooldown(mind_blast) > 0 and Spell(mind_blast) or BuffRemaining(insanity_buff) < 0.5 * GCD() and Enemies() >= 3 and SpellCooldown(mind_blast) > 0.5 * GCD() and Spell(searing_insanity) or Enemies() >= 3 and SpellCooldown(mind_blast) > 0.5 * GCD() and Spell(searing_insanity)
	{
...
AddFunction ShadowCopInsanityMainActions
{
	...
	#searing_insanity,if=buff.insanity.remains<0.5*gcd&active_enemies>=3&cooldown.mind_blast.remains>0.5*gcd,chain=1,interrupt_if=(cooldown.mind_blast.remains<=0.1|cooldown.shadow_word_death.remains<=0.1)
	if BuffRemaining(insanity_buff) < 0.5 * GCD() and Enemies() >= 3 and SpellCooldown(mind_blast) > 0.5 * GCD() Spell(searing_insanity)
	#searing_insanity,if=active_enemies>=5,chain=1,interrupt_if=(cooldown.mind_blast.remains<=0.1|cooldown.shadow_word_death.remains<=0.1)
...
{
	{ ShadowOrbs() == 5 or Enemies() >= 5 and not BuffPresent(insanity_buff) } and Spell(devouring_plague) or BuffRemaining(mental_instinct_buff) < GCD() * 1.7 and BuffRemaining(mental_instinct_buff) > GCD() * 0.7 and BuffPresent(mental_instinct_buff) and Spell(devouring_plague) or Glyph(glyph_of_mind_harvest) and target.MindHarvest() == 0 and Spell(mind_blast) or Enemies() <= 5 and not SpellCooldown(mind_blast) > 0 and Spell(mind_blast) or target.HealthPercent() < 20 and not target.DebuffPresent(shadow_word_pain_debuff) and not target.DebuffPresent(vampiric_touch_debuff) and Spell(shadow_word_death) or target.HealthPercent() < 20 and Spell(shadow_word_death) or ShadowOrbs() >= 3 and not ArmorSetBonus(T17 2) and not ArmorSetBonus(T17 4) and { SpellCooldown(mind_blast) < GCD() or target.HealthPercent() < 20 and SpellCooldown(shadow_word_death) < GCD() } and Spell(devouring_plague) or ShadowOrbs() >= 3 and ArmorSetBonus(T17 2) and not ArmorSetBonus(T17 4) and { SpellCooldown(mind_blast) <= 2 or target.HealthPercent() < 20 and SpellCooldown(shadow_word_death) < GCD() } and Spell(devouring_plague) or BuffRemaining(insanity_buff) < 0.5 * GCD() and Enemies() >= 3 and SpellCooldown(mind_blast) > 0.5 * GCD() and Spell(searing_insanity) or Enemies() >= 5 and Spell(searing_insanity) or DebuffCountOnAny(shadow_word_pain_debuff) < Enemies() and DebuffCountOnAny(shadow_word_pain_debuff) <= 5 and target.DebuffRemaining(shadow_word_pain_debuff) < 18 * 0.3 and target.TimeToDie() > 18 * 0.75 and True(miss_react) and Enemies() <= 5 and 1 == 0 and Spell(shadow_word_pain) or DebuffCountOnAny(vampiric_touch_debuff) < Enemies() and DebuffCountOnAny(vampiric_touch_debuff) <= 5 and target.DebuffRemaining(vampiric_touch_debuff) < 15 * 0.3 + CastTime(vampiric_touch) and target.TimeToDie() > 15 * 0.75 + CastTime(vampiric_touch) and True(miss_react) and Enemies() <= 5 and 1 == 0 and Spell(vampiric_touch) or BuffRemaining(insanity_buff) < 0.5 * GCD() and Enemies() <= 2 and Spell(insanity) or Enemies() <= 2 and Spell(insanity) or Enemies() >= 8 and Spell(mind_sear) or Spell(mind_spike) or Speed() > 0 and not target.DebuffPresent(shadow_word_pain_debuff) and not target.DebuffPresent(vampiric_touch_debuff) and Spell(shadow_word_death) or Speed() > 0 and 0 >= 1 * GCD() and Spell(shadow_word_death) or Speed() > 0 and Talent(body_and_soul_talent) and 0 >= 25 and Spell(power_word_shield) or Speed() > 0 and Spell(devouring_plague) or Speed() > 0 and 1 == 0 and Spell(shadow_word_pain)
}

AddFunction ShadowCopInsanityCdActions
{
	unless { ShadowOrbs() == 5 or Enemies() >= 5 and not BuffPresent(insanity_buff) } and Spell(devouring_plague) or BuffRemaining(mental_instinct_buff) < GCD() * 1.7 and BuffRemaining(mental_instinct_buff) > GCD() * 0.7 and BuffPresent(mental_instinct_buff) and Spell(devouring_plague) or Glyph(glyph_of_mind_harvest) and target.MindHarvest() == 0 and Spell(mind_blast) or Enemies() <= 5 and not SpellCooldown(mind_blast) > 0 and Spell(mind_blast) or target.HealthPercent() < 20 and not target.DebuffPresent(shadow_word_pain_debuff) and not target.DebuffPresent(vampiric_touch_debuff) and Spell(shadow_word_death) or target.HealthPercent() < 20 and Spell(shadow_word_death) or ShadowOrbs() >= 3 and not ArmorSetBonus(T17 2) and not ArmorSetBonus(T17 4) and { SpellCooldown(mind_blast) < GCD() or target.HealthPercent() < 20 and SpellCooldown(shadow_word_death) < GCD() } and Spell(devouring_plague) or ShadowOrbs() >= 3 and ArmorSetBonus(T17 2) and not ArmorSetBonus(T17 4) and { SpellCooldown(mind_blast) <= 2 or target.HealthPercent() < 20 and SpellCooldown(shadow_word_death) < GCD() } and Spell(devouring_plague) or BuffRemaining(insanity_buff) < 0.5 * GCD() and Enemies() >= 3 and SpellCooldown(mind_blast) > 0.5 * GCD() and Spell(searing_insanity) or Enemies() >= 5 and Spell(searing_insanity)
	{
		#mindbender,if=talent.mindbender.enabled
		if Talent(mindbender_talent) Spell(mindbender)
		#shadowfiend,if=!talent.mindbender.enabled
...
{
	{ ShadowOrbs() == 5 or Enemies() >= 5 and not BuffPresent(insanity_buff) } and Spell(devouring_plague) or BuffRemaining(mental_instinct_buff) < GCD() * 1.7 and BuffRemaining(mental_instinct_buff) > GCD() * 0.7 and BuffPresent(mental_instinct_buff) and Spell(devouring_plague) or Glyph(glyph_of_mind_harvest) and target.MindHarvest() == 0 and Spell(mind_blast) or Enemies() <= 5 and not SpellCooldown(mind_blast) > 0 and Spell(mind_blast) or target.HealthPercent() < 20 and not target.DebuffPresent(shadow_word_pain_debuff) and not target.DebuffPresent(vampiric_touch_debuff) and Spell(shadow_word_death) or target.HealthPercent() < 20 and Spell(shadow_word_death) or ShadowOrbs() >= 3 and not ArmorSetBonus(T17 2) and not ArmorSetBonus(T17 4) and { SpellCooldown(mind_blast) < GCD() or target.HealthPercent() < 20 and SpellCooldown(shadow_word_death) < GCD() } and Spell(devouring_plague) or ShadowOrbs() >= 3 and ArmorSetBonus(T17 2) and not ArmorSetBonus(T17 4) and { SpellCooldown(mind_blast) <= 2 or target.HealthPercent() < 20 and SpellCooldown(shadow_word_death) < GCD() } and Spell(devouring_plague) or BuffRemaining(insanity_buff) < 0.5 * GCD() and Enemies() >= 3 and SpellCooldown(mind_blast) > 0.5 * GCD() and Spell(searing_insanity) or Enemies() >= 5 and Spell(searing_insanity) or DebuffCountOnAny(shadow_word_pain_debuff) < Enemies() and DebuffCountOnAny(shadow_word_pain_debuff) <= 5 and target.DebuffRemaining(shadow_word_pain_debuff) < 18 * 0.3 and target.TimeToDie() > 18 * 0.75 and True(miss_react) and Enemies() <= 5 and 1 == 0 and Spell(shadow_word_pain) or DebuffCountOnAny(vampiric_touch_debuff) < Enemies() and DebuffCountOnAny(vampiric_touch_debuff) <= 5 and target.DebuffRemaining(vampiric_touch_debuff) < 15 * 0.3 + CastTime(vampiric_touch) and target.TimeToDie() > 15 * 0.75 + CastTime(vampiric_touch) and True(miss_react) and Enemies() <= 5 and 1 == 0 and Spell(vampiric_touch) or BuffRemaining(insanity_buff) < 0.5 * GCD() and Enemies() <= 2 and Spell(insanity) or Enemies() <= 2 and Spell(insanity) or Talent(halo_talent) and target.Distance() <= 30 and target.Distance() >= 17 and Spell(halo_caster) or Talent(cascade_talent) and { Enemies() > 1 or target.Distance() >= 28 } and target.Distance() <= 40 and target.Distance() >= 11 and Spell(cascade_caster) or Talent(divine_star_talent) and Enemies() > 2 and target.Distance() <= 24 and Spell(divine_star_caster) or Enemies() >= 8 and Spell(mind_sear) or Spell(mind_spike) or Speed() > 0 and not target.DebuffPresent(shadow_word_pain_debuff) and not target.DebuffPresent(vampiric_touch_debuff) and Spell(shadow_word_death) or Speed() > 0 and 0 >= 1 * GCD() and Spell(shadow_word_death) or Speed() > 0 and Talent(body_and_soul_talent) and 0 >= 25 and Spell(power_word_shield) or Talent(halo_talent) and target.Distance() <= 30 and Speed() > 0 and Spell(halo_caster) or Talent(divine_star_talent) and target.Distance() <= 28 and Speed() > 0 and Spell(divine_star_caster) or Talent(cascade_talent) and target.Distance() <= 40 and Speed() > 0 and Spell(cascade_caster) or Speed() > 0 and Spell(devouring_plague) or Speed() > 0 and 1 == 0 and Spell(shadow_word_pain)
}
