...
do
	local name = "simulationcraft_priest_shadow_t17m_cop"
...
AddFunction ShadowCopMainActions
{
	...
	#devouring_plague,if=shadow_orb>=3&set_bonus.tier17_2pc&!set_bonus.tier17_4pc&(cooldown.mind_blast.remains<=2|(cooldown.shadow_word_death.remains<=gcd&target.health.pct<20))&primary_target=0&target.time_to_die>=(gcd*4*7%6),cycle_targets=1
	if ShadowOrbs() >= 3 and ArmorSetBonus(T17 2) and not ArmorSetBonus(T17 4) and { SpellCooldown(mind_blast) <= 2 or SpellCooldown(shadow_word_death) <= GCD() and target.HealthPercent() < 20 } and 1 == 0 and target.TimeToDie() >= GCD() * 4 * 7 / 6 Spell(devouring_plague)
	#devouring_plague,if=shadow_orb>=3&set_bonus.tier17_2pc&!set_bonus.tier17_4pc&(cooldown.mind_blast.remains<=2|(cooldown.shadow_word_death.remains<=gcd&target.health.pct<20))
	if ShadowOrbs() >= 3 and ArmorSetBonus(T17 2) and not ArmorSetBonus(T17 4) and { SpellCooldown(mind_blast) <= 2 or SpellCooldown(shadow_word_death) <= GCD() and target.HealthPercent() < 20 } Spell(devouring_plague)
...
AddFunction ShadowCopShortCdActions
{
	unless ShadowOrbs() == 5 and 1 == 0 and not target.DebuffPresent(devouring_plague_dot_debuff) and target.TimeToDie() >= GCD() * 4 * 7 / 6 and Spell(devouring_plague) or ShadowOrbs() == 5 and not target.DebuffPresent(devouring_plague_dot_debuff) and Spell(devouring_plague) or ShadowOrbs() == 5 and 1 == 0 and target.TimeToDie() >= GCD() * 4 * 7 / 6 and { SpellCooldown(mind_blast) <= GCD() or SpellCooldown(shadow_word_death) <= GCD() and target.HealthPercent() < 20 } and Spell(devouring_plague) or ShadowOrbs() == 5 and { SpellCooldown(mind_blast) <= GCD() or SpellCooldown(shadow_word_death) <= GCD() and target.HealthPercent() < 20 } and Spell(devouring_plague) or 1 == 0 and BuffRemaining(mental_instinct_buff) < GCD() and BuffRemaining(mental_instinct_buff) > GCD() * 0.7 and BuffPresent(mental_instinct_buff) and Spell(devouring_plague) or BuffRemaining(mental_instinct_buff) < GCD() and BuffRemaining(mental_instinct_buff) > GCD() * 0.7 and BuffPresent(mental_instinct_buff) and Spell(devouring_plague) or ShadowOrbs() >= 3 and not ArmorSetBonus(T17 2) and not ArmorSetBonus(T17 4) and { SpellCooldown(mind_blast) <= GCD() or SpellCooldown(shadow_word_death) <= GCD() and target.HealthPercent() < 20 } and 1 == 0 and target.TimeToDie() >= GCD() * 4 * 7 / 6 and Spell(devouring_plague) or ShadowOrbs() >= 3 and not ArmorSetBonus(T17 2) and not ArmorSetBonus(T17 4) and { SpellCooldown(mind_blast) <= GCD() or SpellCooldown(shadow_word_death) <= GCD() and target.HealthPercent() < 20 } and Spell(devouring_plague) or ShadowOrbs() >= 3 and ArmorSetBonus(T17 2) and not ArmorSetBonus(T17 4) and { SpellCooldown(mind_blast) <= 2 or SpellCooldown(shadow_word_death) <= GCD() and target.HealthPercent() < 20 } and 1 == 0 and target.TimeToDie() >= GCD() * 4 * 7 / 6 and Spell(devouring_plague) or ShadowOrbs() >= 3 and ArmorSetBonus(T17 2) and not ArmorSetBonus(T17 4) and { SpellCooldown(mind_blast) <= 2 or SpellCooldown(shadow_word_death) <= GCD() and target.HealthPercent() < 20 } and Spell(devouring_plague) or target.MindHarvest() == 0 and Spell(mind_blast) or Enemies() <= 5 and not SpellCooldown(mind_blast) > 0 and Spell(mind_blast) or target.HealthPercent() < 20 and not target.DebuffPresent(shadow_word_pain_debuff) and not target.DebuffPresent(vampiric_touch_debuff) and Spell(shadow_word_death) or target.HealthPercent() < 20 and Spell(shadow_word_death) or BuffRemaining(shadow_word_insanity_buff) < 0.5 * GCD() and Enemies() >= 3 and SpellCooldown(mind_blast) > 0.5 * GCD() and Spell(searing_insanity) or Enemies() >= 3 and SpellCooldown(mind_blast) > 0.5 * GCD() and Spell(searing_insanity)
	{
		...
		unless DebuffCountOnAny(shadow_word_pain_debuff) < Enemies() and DebuffCountOnAny(shadow_word_pain_debuff) <= 5 and True(miss_react) and not target.DebuffPresent(shadow_word_pain_debuff) and Enemies() <= 5 and 1 == 0 and Spell(shadow_word_pain) or DebuffCountOnAny(vampiric_touch_debuff) < Enemies() and DebuffCountOnAny(vampiric_touch_debuff) <= 5 and target.DebuffRemaining(vampiric_touch_debuff) < CastTime(vampiric_touch) and True(miss_react) and Enemies() <= 5 and 1 == 0 and Spell(vampiric_touch)
		{
			...
			unless Enemies() >= 5 and Spell(mind_sear) or Enemies() <= 4 and BuffPresent(surge_of_darkness_buff) and Spell(mind_spike) or Enemies() >= 3 and Spell(mind_sear) or target.TicksRemaining(devouring_plague_debuff) > 1 and Enemies() == 1 and Spell(mind_flay) or Spell(mind_spike) or Speed() > 0 and not target.DebuffPresent(shadow_word_pain_debuff) and not target.DebuffPresent(vampiric_touch_debuff) and Spell(shadow_word_death) or Speed() > 0 and 0 >= 1 * GCD() and Spell(shadow_word_death) or Speed() > 0 and Talent(body_and_soul_talent) and 0 >= 25 and Spell(power_word_shield)
			{
...
{
	ShadowOrbs() == 5 and 1 == 0 and not target.DebuffPresent(devouring_plague_dot_debuff) and target.TimeToDie() >= GCD() * 4 * 7 / 6 and Spell(devouring_plague) or ShadowOrbs() == 5 and not target.DebuffPresent(devouring_plague_dot_debuff) and Spell(devouring_plague) or ShadowOrbs() == 5 and 1 == 0 and target.TimeToDie() >= GCD() * 4 * 7 / 6 and { SpellCooldown(mind_blast) <= GCD() or SpellCooldown(shadow_word_death) <= GCD() and target.HealthPercent() < 20 } and Spell(devouring_plague) or ShadowOrbs() == 5 and { SpellCooldown(mind_blast) <= GCD() or SpellCooldown(shadow_word_death) <= GCD() and target.HealthPercent() < 20 } and Spell(devouring_plague) or 1 == 0 and BuffRemaining(mental_instinct_buff) < GCD() and BuffRemaining(mental_instinct_buff) > GCD() * 0.7 and BuffPresent(mental_instinct_buff) and Spell(devouring_plague) or BuffRemaining(mental_instinct_buff) < GCD() and BuffRemaining(mental_instinct_buff) > GCD() * 0.7 and BuffPresent(mental_instinct_buff) and Spell(devouring_plague) or ShadowOrbs() >= 3 and not ArmorSetBonus(T17 2) and not ArmorSetBonus(T17 4) and { SpellCooldown(mind_blast) <= GCD() or SpellCooldown(shadow_word_death) <= GCD() and target.HealthPercent() < 20 } and 1 == 0 and target.TimeToDie() >= GCD() * 4 * 7 / 6 and Spell(devouring_plague) or ShadowOrbs() >= 3 and not ArmorSetBonus(T17 2) and not ArmorSetBonus(T17 4) and { SpellCooldown(mind_blast) <= GCD() or SpellCooldown(shadow_word_death) <= GCD() and target.HealthPercent() < 20 } and Spell(devouring_plague) or ShadowOrbs() >= 3 and ArmorSetBonus(T17 2) and not ArmorSetBonus(T17 4) and { SpellCooldown(mind_blast) <= 2 or SpellCooldown(shadow_word_death) <= GCD() and target.HealthPercent() < 20 } and 1 == 0 and target.TimeToDie() >= GCD() * 4 * 7 / 6 and Spell(devouring_plague) or ShadowOrbs() >= 3 and ArmorSetBonus(T17 2) and not ArmorSetBonus(T17 4) and { SpellCooldown(mind_blast) <= 2 or SpellCooldown(shadow_word_death) <= GCD() and target.HealthPercent() < 20 } and Spell(devouring_plague) or target.MindHarvest() == 0 and Spell(mind_blast) or Enemies() <= 5 and not SpellCooldown(mind_blast) > 0 and Spell(mind_blast) or target.HealthPercent() < 20 and not target.DebuffPresent(shadow_word_pain_debuff) and not target.DebuffPresent(vampiric_touch_debuff) and Spell(shadow_word_death) or target.HealthPercent() < 20 and Spell(shadow_word_death) or BuffRemaining(shadow_word_insanity_buff) < 0.5 * GCD() and Enemies() >= 3 and SpellCooldown(mind_blast) > 0.5 * GCD() and Spell(searing_insanity) or Enemies() >= 3 and SpellCooldown(mind_blast) > 0.5 * GCD() and Spell(searing_insanity) or DebuffCountOnAny(shadow_word_pain_debuff) < Enemies() and DebuffCountOnAny(shadow_word_pain_debuff) <= 5 and True(miss_react) and not target.DebuffPresent(shadow_word_pain_debuff) and Enemies() <= 5 and 1 == 0 and Spell(shadow_word_pain) or DebuffCountOnAny(vampiric_touch_debuff) < Enemies() and DebuffCountOnAny(vampiric_touch_debuff) <= 5 and target.DebuffRemaining(vampiric_touch_debuff) < CastTime(vampiric_touch) and True(miss_react) and Enemies() <= 5 and 1 == 0 and Spell(vampiric_touch) or Enemies() >= 5 and Spell(mind_sear) or Enemies() <= 4 and BuffPresent(surge_of_darkness_buff) and Spell(mind_spike) or Enemies() >= 3 and Spell(mind_sear) or target.TicksRemaining(devouring_plague_debuff) > 1 and Enemies() == 1 and Spell(mind_flay) or Spell(mind_spike) or Speed() > 0 and not target.DebuffPresent(shadow_word_pain_debuff) and not target.DebuffPresent(vampiric_touch_debuff) and Spell(shadow_word_death) or Speed() > 0 and 0 >= 1 * GCD() and Spell(shadow_word_death) or Speed() > 0 and Talent(body_and_soul_talent) and 0 >= 25 and Spell(power_word_shield) or Speed() > 0 and Spell(devouring_plague)
}
...
{
	ShadowOrbs() == 5 and 1 == 0 and not target.DebuffPresent(devouring_plague_dot_debuff) and target.TimeToDie() >= GCD() * 4 * 7 / 6 and Spell(devouring_plague) or ShadowOrbs() == 5 and not target.DebuffPresent(devouring_plague_dot_debuff) and Spell(devouring_plague) or ShadowOrbs() == 5 and 1 == 0 and target.TimeToDie() >= GCD() * 4 * 7 / 6 and { SpellCooldown(mind_blast) <= GCD() or SpellCooldown(shadow_word_death) <= GCD() and target.HealthPercent() < 20 } and Spell(devouring_plague) or ShadowOrbs() == 5 and { SpellCooldown(mind_blast) <= GCD() or SpellCooldown(shadow_word_death) <= GCD() and target.HealthPercent() < 20 } and Spell(devouring_plague) or 1 == 0 and BuffRemaining(mental_instinct_buff) < GCD() and BuffRemaining(mental_instinct_buff) > GCD() * 0.7 and BuffPresent(mental_instinct_buff) and Spell(devouring_plague) or BuffRemaining(mental_instinct_buff) < GCD() and BuffRemaining(mental_instinct_buff) > GCD() * 0.7 and BuffPresent(mental_instinct_buff) and Spell(devouring_plague) or ShadowOrbs() >= 3 and not ArmorSetBonus(T17 2) and not ArmorSetBonus(T17 4) and { SpellCooldown(mind_blast) <= GCD() or SpellCooldown(shadow_word_death) <= GCD() and target.HealthPercent() < 20 } and 1 == 0 and target.TimeToDie() >= GCD() * 4 * 7 / 6 and Spell(devouring_plague) or ShadowOrbs() >= 3 and not ArmorSetBonus(T17 2) and not ArmorSetBonus(T17 4) and { SpellCooldown(mind_blast) <= GCD() or SpellCooldown(shadow_word_death) <= GCD() and target.HealthPercent() < 20 } and Spell(devouring_plague) or ShadowOrbs() >= 3 and ArmorSetBonus(T17 2) and not ArmorSetBonus(T17 4) and { SpellCooldown(mind_blast) <= 2 or SpellCooldown(shadow_word_death) <= GCD() and target.HealthPercent() < 20 } and 1 == 0 and target.TimeToDie() >= GCD() * 4 * 7 / 6 and Spell(devouring_plague) or ShadowOrbs() >= 3 and ArmorSetBonus(T17 2) and not ArmorSetBonus(T17 4) and { SpellCooldown(mind_blast) <= 2 or SpellCooldown(shadow_word_death) <= GCD() and target.HealthPercent() < 20 } and Spell(devouring_plague) or target.MindHarvest() == 0 and Spell(mind_blast) or Enemies() <= 5 and not SpellCooldown(mind_blast) > 0 and Spell(mind_blast) or target.HealthPercent() < 20 and not target.DebuffPresent(shadow_word_pain_debuff) and not target.DebuffPresent(vampiric_touch_debuff) and Spell(shadow_word_death) or target.HealthPercent() < 20 and Spell(shadow_word_death) or BuffRemaining(shadow_word_insanity_buff) < 0.5 * GCD() and Enemies() >= 3 and SpellCooldown(mind_blast) > 0.5 * GCD() and Spell(searing_insanity) or Enemies() >= 3 and SpellCooldown(mind_blast) > 0.5 * GCD() and Spell(searing_insanity) or Talent(halo_talent) and target.Distance() <= 30 and target.Distance() >= 17 and Spell(halo_caster) or Talent(cascade_talent) and { Enemies() > 1 or target.Distance() >= 28 } and target.Distance() <= 40 and target.Distance() >= 11 and Spell(cascade_caster) or Talent(divine_star_talent) and Enemies() > 3 and target.Distance() <= 24 and Spell(divine_star_caster) or DebuffCountOnAny(shadow_word_pain_debuff) < Enemies() and DebuffCountOnAny(shadow_word_pain_debuff) <= 5 and True(miss_react) and not target.DebuffPresent(shadow_word_pain_debuff) and Enemies() <= 5 and 1 == 0 and Spell(shadow_word_pain) or DebuffCountOnAny(vampiric_touch_debuff) < Enemies() and DebuffCountOnAny(vampiric_touch_debuff) <= 5 and target.DebuffRemaining(vampiric_touch_debuff) < CastTime(vampiric_touch) and True(miss_react) and Enemies() <= 5 and 1 == 0 and Spell(vampiric_touch) or Talent(divine_star_talent) and Enemies() == 3 and target.Distance() <= 24 and Spell(divine_star_caster) or Enemies() >= 5 and Spell(mind_sear) or Enemies() <= 4 and BuffPresent(surge_of_darkness_buff) and Spell(mind_spike) or Enemies() >= 3 and Spell(mind_sear) or target.TicksRemaining(devouring_plague_debuff) > 1 and Enemies() == 1 and Spell(mind_flay) or Spell(mind_spike) or Speed() > 0 and not target.DebuffPresent(shadow_word_pain_debuff) and not target.DebuffPresent(vampiric_touch_debuff) and Spell(shadow_word_death) or Speed() > 0 and 0 >= 1 * GCD() and Spell(shadow_word_death) or Speed() > 0 and Talent(body_and_soul_talent) and 0 >= 25 and Spell(power_word_shield) or Speed() > 0 and Talent(halo_talent) and target.Distance() <= 30 and Spell(halo_caster) or Talent(divine_star_talent) and target.Distance() <= 28 and Speed() > 0 and Spell(divine_star_caster) or Talent(cascade_talent) and target.Distance() <= 40 and Speed() > 0 and Spell(cascade_caster) or Speed() > 0 and Spell(devouring_plague)
}
...
AddFunction ShadowCopDotweaveShortCdActions
{
	unless target.DebuffPresent(vampiric_touch_debuff) and target.DebuffPresent(shadow_word_pain_debuff) and ShadowOrbs() == 5 and not SpellCooldown(devouring_plague) > 0 and Spell(devouring_plague) or BuffRemaining(mental_instinct_buff) < GCD() and BuffRemaining(mental_instinct_buff) > GCD() * 0.7 and BuffPresent(mental_instinct_buff) and Spell(devouring_plague) or target.DebuffPresent(vampiric_touch_debuff) and target.DebuffPresent(shadow_word_pain_debuff) and not BuffPresent(shadow_word_insanity_buff) and SpellCooldown(mind_blast) > 0.4 * GCD() and Spell(devouring_plague) or target.HealthPercent() < 20 and not target.DebuffPresent(shadow_word_pain_debuff) and not target.DebuffPresent(vampiric_touch_debuff) and Spell(shadow_word_death) or target.HealthPercent() < 20 and Spell(shadow_word_death) or Glyph(glyph_of_mind_harvest) and target.MindHarvest() == 0 and ShadowOrbs() <= 2 and Spell(mind_blast) or ShadowOrbs() <= 4 and not SpellCooldown(mind_blast) > 0 and Spell(mind_blast) or BuffRemaining(shadow_word_insanity_buff) < 0.5 * GCD() and Enemies() >= 3 and SpellCooldown(mind_blast) > 0.5 * GCD() and Spell(searing_insanity) or Enemies() >= 3 and SpellCooldown(mind_blast) > 0.5 * GCD() and Spell(searing_insanity) or ShadowOrbs() == 4 and ArmorSetBonus(T17 2) and not target.DebuffPresent(shadow_word_pain_debuff) and not target.DebuffPresent(devouring_plague_debuff) and SpellCooldown(mind_blast) < 1.2 * GCD() and SpellCooldown(mind_blast) > 0.2 * GCD() and Spell(shadow_word_pain) or ShadowOrbs() == 5 and not target.DebuffPresent(devouring_plague_debuff) and not target.DebuffPresent(shadow_word_pain_debuff) and Spell(shadow_word_pain) or ShadowOrbs() == 5 and not target.DebuffPresent(devouring_plague_debuff) and not target.DebuffPresent(vampiric_touch_debuff) and Spell(vampiric_touch) or BuffPresent(shadow_word_insanity_buff) and Spell(insanity) or ShadowOrbs() >= 2 and target.DebuffRemaining(shadow_word_pain_debuff) >= 6 and SpellCooldown(mind_blast) > 0.5 * GCD() and target.DebuffRemaining(vampiric_touch_debuff) and BuffPresent(burst_haste_buff any=1) and not ArmorSetBonus(T17 2) and Spell(shadow_word_pain) or ShadowOrbs() >= 2 and target.DebuffRemaining(vampiric_touch_debuff) >= 5 and SpellCooldown(mind_blast) > 0.5 * GCD() and BuffPresent(burst_haste_buff any=1) and not ArmorSetBonus(T17 2) and Spell(vampiric_touch)
	{
		...
		unless DebuffCountOnAny(shadow_word_pain_debuff) < Enemies() and DebuffCountOnAny(shadow_word_pain_debuff) <= 5 and 1 == 0 and not target.DebuffPresent(shadow_word_pain_debuff) and Spell(shadow_word_pain) or DebuffCountOnAny(vampiric_touch_debuff) < Enemies() and DebuffCountOnAny(vampiric_touch_debuff) <= 5 and 1 == 0 and not target.DebuffPresent(vampiric_touch_debuff) and Spell(vampiric_touch)
		{
			...
			unless DebuffCountOnAny(shadow_word_pain_debuff) < Enemies() and DebuffCountOnAny(shadow_word_pain_debuff) <= 5 and 1 == 0 and { not target.DebuffPresent(shadow_word_pain_debuff) or target.DebuffRemaining(shadow_word_pain_debuff) <= 18 * 0.3 } and Spell(shadow_word_pain) or DebuffCountOnAny(vampiric_touch_debuff) < Enemies() and DebuffCountOnAny(vampiric_touch_debuff) <= 5 and 1 == 0 and { not target.DebuffPresent(vampiric_touch_debuff) or target.DebuffRemaining(vampiric_touch_debuff) <= 15 * 0.3 } and Spell(vampiric_touch) or Spell(mind_spike) or Speed() > 0 and not target.DebuffPresent(shadow_word_pain_debuff) and not target.DebuffPresent(vampiric_touch_debuff) and Spell(shadow_word_death) or Speed() > 0 and 0 >= 1 * GCD() and Spell(shadow_word_death) or Speed() > 0 and Talent(body_and_soul_talent) and 0 >= 25 and Spell(power_word_shield)
			{
