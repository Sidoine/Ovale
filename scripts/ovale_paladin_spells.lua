...
Define(avenging_wrath_melee 31884)
	SpellInfo(avenging_wrath_melee cd=180)
...
Define(avenging_wrath_melee_buff 31884)
	...
	SpellInfo(avenging_wrath_melee_buff addduration=10 talent=sanctified_wrath_talent)
...
Define(blinding_light_talent 6)
...
Define(final_verdict 157048)
	...
	SpellInfo(final_verdict buff_holy_none=divine_purpose_buff talent=divine_purpose_talent)
...
Define(flash_of_light 19750)
	SpellAddBuff(flash_of_light selfless_healer_buff=0 talent=selfless_healer_talent)
...
Define(guardian_of_ancient_kings 86659)
	SpellInfo(guardian_of_ancient_kings cd=180)
...
Define(hammer_of_wrath 24275)
	...
	SpellInfo(hammer_of_wrath cd=3 specialization=retribution talent=sanctified_wrath_talent)
...
Define(hammer_of_wrath_empowered 158392)
	...
	SpellInfo(hammer_of_wrath_empowered cd=3 specialization=retribution talent=sanctified_wrath_talent)
...
Define(holy_wrath 119072)
	...
	SpellInfo(holy_wrath holy=-1 talent=sanctified_wrath_talent)
...
Define(judgment 20271)
	...
	SpellInfo(judgment selfless_healer_buff=1 talent=selfless_healer_talent)
	SpellAddBuff(judgment liadrins_righteousness_buff=1 if_stance=paladin_seal_of_righteousness talent=empowered_seals_talent)
	SpellAddBuff(judgment maraads_truth_buff=1 if_stance=paladin_seal_of_truth talent=empowered_seals_talent)
	SpellAddBuff(judgment uthers_insight_buff=1 if_stance=paladin_seal_of_insight talent=empowered_seals_talent)
...
Define(seraphim 152262)
	SpellInfo(seraphim cd=30 holy=5)
...
Define(speed_of_light 85499)
	SpellInfo(speed_of_light cd=45)
