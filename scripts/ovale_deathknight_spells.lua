...
Define(empower_rune_weapon 47568)
	...
	SpellInfo(empower_rune_weapon replace=hungering_rune_weapon talent=hungering_rune_weapon_talent)
...
Define(frost_strike 49143)
	...
	SpellRequire(frost_strike killing_machine_buff 1=buff,obliteration_buff)
...
Define(horn_of_winter 57330)
	SpellInfo(horn_of_winter cd=30 runes=-2 runicpower=-20 tag=main)
...
Define(obliteration 207256)
	SpellInfo(obliteration cd=90 tag=main offgcd=1 gcd=0)
	SpellAddBuff(obliteration obliteration_buff=1)
Define(obliteration_buff 207256)
	SpellInfo(obliteration_buff duration=8)
