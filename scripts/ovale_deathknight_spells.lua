...
Define(death_strike 49998)
	...
	SpellInfo(death_strike buff_runes_none=dark_succor_buff if_spell=dark_succor if_stance=deathknight_frost_presence)
	SpellInfo(death_strike buff_runes_none=dark_succor_buff if_spell=dark_succor if_stance=deathknight_unholy_presence)
...
Define(defile 152280)
	...
	SpellInfo(defile buff_runes_none=crimson_scourge_buff if_spell=crimson_scourge)
