...
Define(empower_rune_weapon 47568)
	SpellInfo(empower_rune_weapon cd=180 runicpower=-25 runes=-6)
...
Define(horn_of_winter 57330)
	SpellInfo(horn_of_winter cd=30 runes=-2 runicpower=-20)
...
Define(hungering_rune_weapon 207127)
	SpellInfo(hungering_rune_weapon cd=180 runicpower=-25 runes=-6)
