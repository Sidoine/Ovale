...
Define(ascendance_restoration 114052)
	SpellInfo(ascendance_restoration cd=180 gcd=0 offgcd=1)
	SpellAddBuff(ascendance_restoration ascendance_restoration_buff=1)
...
Define(healing_stream_totem 5394)
	...
	SpellInfo(healing_stream_totem charges=2 talent=echo_of_the_elements_talent)
...
Define(riptide 61295)
	...
	SpellInfo(riptide charges=2 talent=echo_of_the_elements_talent)
	SpellAddTargetBuff(riptide riptide_buff=1)
	SpellAddBuff(riptide tidal_waves_buff=1 talent=!crashing_waves_talent)
	SpellAddBuff(riptide tidal_waves_buff=2 talent=crashing_waves_talent)
Define(riptide_buff 61295)
	SpellInfo(riptide_buff duration=18)
Define(tidal_waves_buff 53390)
	SpellInfo(tidal_waves_buff duration=15)
...
Define(crashing_waves_talent 10)
