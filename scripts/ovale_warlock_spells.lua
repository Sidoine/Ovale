...
Define(demonic_empowerment 193396)
	...
	SpellAddBuff(demonic_empowerment shadowy_inspiration_buff=1 talent=shadowy_inspiration_talent)
...
Define(rain_of_fire 5740)
	SpellInfo(rain_of_fire soulshards=3 specialization=destruction)
...
Define(shadowy_inspiration_buff 196606)
	SpellInfo(shadowy_inspiration_buff duration=15)
...
Define(concordance_of_the_legionfall_buff 239042)
	SpellInfo(concordance_of_the_legionfall_buff duration=10)
