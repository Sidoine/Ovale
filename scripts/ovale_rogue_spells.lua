...
Define(adrenaline_rush 13750)
	...
	SpellAddBuff(adrenaline_rush loaded_dice_buff=1 trait=loaded_dice_trait)
...
Define(death_from_above 152150)
	SpellInfo(death_from_above combo=finisher energy=25)
...
Define(eviscerate 196819)
	...
	SpellRequire(eviscerate energy 0=buff,goremaws_bite_buff)
...
Define(loaded_dice_trait 238139)
Define(marked_for_death 137619)
	SpellInfo(marked_for_death cd=60 combo=6 gcd=0 offgcd=1)
...
Define(nightblade 195452)
	...
	SpellRequire(nightblade energy 0=buff,goremaws_bite_buff)
Define(nightblade_debuff 195452)
	SpellInfo(nightblade_debuff duration=6 adddurationcp=2 tick=2)
...
Define(roll_the_bones 193316)
	...
	Define(shark_infested_waters_buff 193357)
		SpellInfo(shark_infested_waters_buff duration=12 adddurationcp=6)
...
Define(slice_and_dice 5171)
	...
	SpellAddBuff(slice_and_dice loaded_dice_buff=0)
...
Define(toxic_blade 245388)
	SpellInfo(toxic_blade energy=20 cd=25 combo=1 tag=main)
