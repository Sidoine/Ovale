...
Define(ghostly_strike 31022)
	SpellInfo(ghostly_strike cd=20)
	SpellAddBuff(ghostly_strike ghostly_strike_buff=1)
Define(ghostly_strike_debuff 31022)
	SpellInfo(ghostly_strike_debuff duration=7)
...
Define(roll_the_bones 193316)
	...
	SpellAddBuff(roll_the_bones roll_the_bones_buff=1)
Define(roll_the_bones_buff 193316)
	SpellInfo(roll_the_bones_buff duration=6 adddurationcp=6)
