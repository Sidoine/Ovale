...
Define(eviscerate 196819)
	...
	SpellAddBuff(eviscerate finality_eviscerate_buff=1)
...
Define(finality_eviscerate_buff 197496)
	SpellInfo(finality_eviscerate_buff duration=30)
Define(find_weakness 91023)
...
Define(loaded_dice_a 238139)
Define(loaded_dice_b 240837)
SpellList(loaded_dice_buff loaded_dice_a loaded_dice_b)
...
Define(symbols_of_death 212283)
	SpellInfo(symbols_of_death cd=30 energy=-40)
...
Define(symbols_of_death_debuff 212283)
	SpellInfo(symbols_of_death_debuff duration=10)
