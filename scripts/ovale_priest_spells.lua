...
Define(mind_blast 8092)
	...
	SpellInfo(mind_blast insanity=-18 talent=fortress_of_the_mind_talent)
...
Define(mind_flay 15407)
	SpellInfo(mind_flay channel=3 insanity=-12 haste=spell)
	SpellInfo(mind_flay insanity=-14 talent=fortress_of_the_mind_talent)
...
Define(purge_the_wicked 204197)
	SpellAddDebuff(purge_the_wicked purge_the_wicked_debuff=1)
...
Define(schism 214621)
	...
	SpellAddDebuff(schism schism_debuff=1)
...
Define(shadow_word_death 32379)
	SpellInfo(shadow_word_death target_health_pct=20 insanity=-15 cd=9)
...
Define(shadowfiend 34433)
	SpellInfo(shadowfiend cd=180 tag=cd)
