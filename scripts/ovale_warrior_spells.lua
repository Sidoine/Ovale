...
Define(execute 5308)
	...
	SpellInfo(execute buff_no_target_health_pct=execute_no_target_health_pct_buff)
	SpellInfo(execute buff_rage_none=sudden_death_buff if_spell=sudden_death)
...
Define(execute_arms 163201)
	SpellInfo(execute rage=10 extra_rage=30 target_health_pct=20)
	SpellInfo(execute buff_no_target_health_pct=execute_no_target_health_pct_buff)
	SpellInfo(execute buff_rage_none=sudden_death_buff if_spell=sudden_death)
	SpellAddBuff(execute death_sentence_buff=0 itemset=T16_melee itemcount=4)
	SpellAddBuff(execute sudden_execute_buff=1 if_spell=sudden_death)
...
Define(heroic_strike 78)
	...
	SpellInfo(heroic_strike buff_rage_none=ultimatum_buff if_spell=ultimatum)
...
Define(impending_victory 103840)
	...
	SpellInfo(impending_victory buff_no_cd=victorious_buff)
...
Define(revenge 6572)
	...
	SpellInfo(revenge unusable=1 stance=warrior_battle_stance)
...
Define(shield_block 2565)
	...
	SpellInfo(shield_block unusable=1 if_stance=warrior_gladiator_stance)
