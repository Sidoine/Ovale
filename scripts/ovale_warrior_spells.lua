...
Define(battle_cry_deadly_calm_buff -1719)
	...
	SpellAddBuff(battle_cry battle_cry_deadly_calm_buff=1 talent=deadly_calm_talent specialization=arms)
...
Define(charge 100)
	...
	SpellInfo(charge addcd=-3 charges=2 talent=double_time_talent)
...
Define(cleave 845)
	...
	SpellInfo(cleave rage_percent=80 talent=dauntless_talent specialization=arms)
	SpellRequire(cleave rage 0=buff,battle_cry_buff talent=deadly_calm_talent specialization=arms)
...
Define(colossus_smash_debuff 167105)
	...
	SpellInfo(colossus_smash_debuff addduration=16 talent=titanic_might_talent specialization=arms)
...
Define(execute 5308)
	...
	SpellRequire(execute rage 0=buff,stone_heart_buff)
...
Define(execute_arms 163201)
	...
	SpellInfo(execute_arms rage_percent=80 talent=dauntless_talent specialization=arms)
	SpellRequire(execute_arms rage 0=buff,battle_cry_buff talent=deadly_calm_talent specialization=arms)
	SpellRequire(execute_arms rage 0=buff,stone_heart_buff)
...
Define(focused_rage 207982)
	...
	SpellInfo(focused_rage rage_percent=80 talent=dauntless_talent specialization=arms)
	SpellRequire(focused_rage rage 0=buff,battle_cry_buff talent=deadly_calm_talent specialization=arms)
...
Define(mortal_strike 12294)
	...
	SpellInfo(mortal_strike rage_percent=80 talent=dauntless_talent specialization=arms)
	SpellInfo(mortal_strike charges=2 talent=mortal_combo_talent specialization=arms)
	SpellRequire(mortal_strike rage 0=buff,battle_cry_buff talent=deadly_calm_talent specialization=arms)
...
Define(overpower 7384)
	...
	SpellRequire(overpower rage 0=buff,battle_cry_buff talent=deadly_calm_talent specialization=arms specialization=arms)
...
Define(rend 772)
	...
	SpellRequire(rend rage 0=buff,battle_cry_buff talent=deadly_calm_talent specialization=arms)
	SpellInfo(rend rage_percent=80 talent=dauntless_talent specialization=arms)
...
Define(revenge 6572)
	...
	SpellRequire(revenge rage 0=buff,revenge_buff)
	SpellAddTargetDebuff(devastate deep_wounds_debuff=1 if_spell=deep_wounds)
...
Define(slam 1464)
	...
	SpellInfo(slam rage_percent=80 talent=dauntless_talent specialization=arms)
	SpellRequire(slam rage 0=buff,battle_cry_buff talent=deadly_calm_talent specialization=arms)
