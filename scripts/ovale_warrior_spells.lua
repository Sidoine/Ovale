...
Define(bladestorm 46924)
	SpellInfo(bladestorm cd=90 channel=6)
...
Define(bounding_stride_talent 10)
Define(charge 100)
...
Define(frenzy 206313)
	SpellAddBuff(frenzy frenzy_buff=1)
...
Define(mortal_strike 12294)
	...
	SpellInfo(mortal_strike cd_haste=melee)
...
Define(rampage 184367)
	...
	SpellInfo(rampage rage=85 talent=!carnage_talent)
...
Define(shattered_defenses_buff 182038)
...
Define(shield_barrier_melee 174926)
	SpellInfo(shield_barrier_melee cd=1.5 gcd=0 rage=20 extra_rage=40)
...
Define(shield_slam 23922)
	...
	SpellInfo(shield_slam cd_haste=melee)
...
Define(thunder_clap 6343)
	...
	SpellInfo(thunder_clap cd_haste=melee)
...
Define(whirlwind 190411)
	...
	SpellAddBuff(whirlwind wrecking_ball_buff=-1)
