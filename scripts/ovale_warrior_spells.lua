...
Define(cleave 845)
	...
	# TODO: Should be 20% but currently can only do percent reductions on buffs
	SpellInfo(cleave rage=8 talent=dauntless_talent)
...
Define(execute_arms 163201)
	...
	# TODO: Should be 20% but currently can only do percent reductions on buffs
	SpellInfo(execute_arms rage=10 talent=dauntless_talent)
...
Define(focused_rage 207982)
	...
	SpellInfo(focused_rage rage=12 talent=dauntless_talent)
...
Define(mortal_strike 12294)
	...
	# TODO: Should be 20% but currently can only do percent reductions on buffs
	SpellInfo(mortal_strike rage=16 talent=dauntless_talent)
...
Define(rend 772)
	...
	# TODO: Should be 20% but currently can only do percent reductions on buffs
	SpellInfo(rend rage=12 talent=dauntless_talent)
...
Define(slam 1464)
	...
	# TODO: Should be 20% but currently can only do percent reductions on buffs
	SpellInfo(slam rage=16 talent=dauntless_talent)
...
Define(whirlwind 190411)
	...
	SpellInfo(whirlwind rage=20 talent=dauntless_talent specialization=arms)
