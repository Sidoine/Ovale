...
Define(mind_flay_(insanity) 129197)
  SpellInfo(mind_flay_(insanity) duration=3 tick=1 canStopChannelling=1 )
  SpellAddTargetDebuff(mind_flay_(insanity) mind_flay_(insanity)=1)
...
AddIcon mastery=3 help=main
{
	...
	if target.TicksRemain(devouring_plague) ==1 Spell(mind_flay_(insanity))
	Spell(mind_flay_(insanity))
