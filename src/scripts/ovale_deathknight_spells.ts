...
export function registerDeathKnightSpells(scripts: OvaleScriptsClass) {
    ...
    const desc = "[9.1] Ovale: Death Knight spells";
...
# Corrupts the targeted ground, causing 52212m1*11 Shadow damage over 10 seconds to targets within the area.?!c2&(a316664|a316916)[rnrnWhile you remain within the area, your ][]?s223829&a316916[Necrotic Strike and ][]?a316664[Heart Strike will hit up to 188290m3 additional targets.]?s207311&a316916[Clawing Shadows will hit up to 55090s4-1 enemies near the target.]?a316916[Scourge Strike will hit up to 55090s4-1 enemies near the target.][]
...
Define(frenzied_monstrosity_buff 334895)
  SpellInfo(frenzied_monstrosity_buff gcd=0 offgcd=1)
  # Damage increased by m2, and attack speed increased by m3.
  SpellAddBuff(frenzied_monstrosity_buff frenzied_monstrosity_buff add=1)
...
# ?s207317[Death Coil and Epidemic reduce][Death Coil reduces] the cooldown of Apocalypse by <cd1> sec and Army of the Dead by <cd2> sec. rnrnApocalypse and Army of the Dead also summon a Magus of the Dead who hurls Frostbolts and Shadow Bolts at your foes.
...
Define(koltiras_favor_runeforge 6944)
Define(phearomones_runeforge 6954)
Define(rage_of_the_frozen_champion_runeforge 7160)
