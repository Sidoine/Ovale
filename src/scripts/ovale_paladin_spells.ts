...
export function register() {
    ...
    let desc = "[7.0] Ovale: Paladin spells";
    let code = `
# Items
...
Define(ardent_defender 31850)
	...
	SpellRequire(ardent_defender add_cd=-36 talent=unbreakable_spirit_talent)
...
Define(avenging_wrath_melee 31884)
	SpellInfo(avenging_wrath_melee cd=120)
...
Define(crusader_strike 35395)
	...
	SpellInfo(crusader_strike cd=3.5 talent=fires_of_justice_talent specialization=retribution)
...
Define(justicars_vengeance 215661)
	...
	SpellInfo(justicars_vengeance add_cd=-36 talent=unbreakable_spirit_talent)
