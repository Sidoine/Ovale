...
export function register() {
	...
	let desc = "[8.1] Ovale: DemonHunter spells";
...
Define(frailty_debuff 247456)
    ...
    SpellRequire(fracture addpain -20=buff,metamorphosis_veng_buff)
...
Define(revolving_blades_buff 279584)
    ...
    SpellRequire(shear addpain -20=buff,metamorphosis_veng_buff)
