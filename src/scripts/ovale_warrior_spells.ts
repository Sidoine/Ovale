...
Define(execute_fury 5308)
	SpellInfo(execute_fury rage=-20 target_health_pct=20)
	SpellInfo(execute_fury target_health_pct=35 talent=massacre_talent_fury specialization=fury)
	SpellRequire(execute_fury target_health_pct 100=buff,sudden_deth_buff_fury specialization=fury)
