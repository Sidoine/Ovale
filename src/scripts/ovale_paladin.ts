...
{
 spell(devotion_aura) or spell(consecration) or spell(lights_judgment)
}

AddFunction protectionprecombatcdactions
{
 unless spell(devotion_aura)
 {
  #snapshot_stats
  #potion
...
{
 buffpresent(avenging_wrath) and spell(fireblood) or spell(seraphim) or spell(avenging_wrath) or { buffpresent(avenging_wrath) or spellcooldown(avenging_wrath) > 60 } and spell(holy_avenger) or previousgcdspell(avengers_shield) and spellcooldown(avengers_shield) > 0 and spell(moment_of_glory) or spell(296208)
}

AddFunction protectioncooldownscdactions
{
 unless buffpresent(avenging_wrath) and spell(fireblood) or spell(seraphim) or spell(avenging_wrath) or { buffpresent(avenging_wrath) or spellcooldown(avenging_wrath) > 60 } and spell(holy_avenger)
 {
...
AddFunction retributionprecombatmainactions
{
 ...
 #snapshot_stats
 #potion
 if checkboxon(opt_use_consumables) and target.classification(worldboss) item(spectral_strength_item usable=1)
 #arcane_torrent
 spell(arcane_torrent)
}
...
{
 checkboxon(opt_use_consumables) and target.classification(worldboss) and item(spectral_strength_item usable=1) or spell(arcane_torrent)
}
...
{
 { holypower() >= 5 or buffpresent(holy_avenger) or target.debuffpresent(final_reckoning) or target.debuffpresent(execution_sentence) or buffpresent(memory_of_lucid_dreams_buff) or buffpresent(seething_rage) } and retributionfinishersshortcdpostconditions() or not target.debuffpresent(judgment_debuff) and { not never(raid_event_adds_exists) or 600 > 30 } and { holypower() <= 2 or holypower() <= 4 and { spellcooldown(blade_of_justice) > gcd() * 2 or target.debuffpresent(execution_sentence) or target.debuffpresent(final_reckoning) } } and { not hastalent(final_reckoning_talent) or spellcooldown(final_reckoning) > gcd() * 10 } and { not hastalent(execution_sentence_talent) or spellcooldown(execution_sentence) > gcd() * 10 } and spell(divine_toll) or { holypower() == 0 or holypower() <= 2 and { spellcooldown(blade_of_justice) > gcd() * 2 or target.debuffpresent(execution_sentence) or target.debuffpresent(final_reckoning) } } and { not never(raid_event_adds_exists) or 600 > 20 } and { not hastalent(execution_sentence_talent) or spellcooldown(execution_sentence) > 15 } and { not hastalent(final_reckoning_talent) or spellcooldown(final_reckoning) > 15 } and spell(wake_of_ashes) or holypower() <= 4 and spell(hammer_of_wrath) or holypower() <= 3 and spell(blade_of_justice) or not target.debuffpresent(judgment_debuff) and { holypower() <= 2 or holypower() <= 4 and spellcooldown(blade_of_justice) > gcd() * 2 } and spell(judgment) or { target.healthpercent() <= 20 or buffpresent(avenging_wrath) or buffpresent(crusade) or buffpresent(empyrean_power_buff) } and retributionfinishersshortcdpostconditions() or spellcharges(crusader_strike count=0) >= 1.75 and { holypower() <= 2 or holypower() <= 3 and spellcooldown(blade_of_justice) > gcd() * 2 or holypower() == 4 and spellcooldown(blade_of_justice) > gcd() * 2 and spellcooldown(judgment) > gcd() * 2 } and spell(crusader_strike) or retributionfinishersshortcdpostconditions() or not buffpresent(consecration) and spell(consecration) or holypower() <= 4 and spell(crusader_strike) or holypower() <= 4 and spell(arcane_torrent) or retributiontimetohpg() > gcd() and spell(consecration)
}
...
{
 { holypower() >= 5 or buffpresent(holy_avenger) or target.debuffpresent(final_reckoning) or target.debuffpresent(execution_sentence) or buffpresent(memory_of_lucid_dreams_buff) or buffpresent(seething_rage) } and retributionfinisherscdpostconditions() or not target.debuffpresent(judgment_debuff) and { not never(raid_event_adds_exists) or 600 > 30 } and { holypower() <= 2 or holypower() <= 4 and { spellcooldown(blade_of_justice) > gcd() * 2 or target.debuffpresent(execution_sentence) or target.debuffpresent(final_reckoning) } } and { not hastalent(final_reckoning_talent) or spellcooldown(final_reckoning) > gcd() * 10 } and { not hastalent(execution_sentence_talent) or spellcooldown(execution_sentence) > gcd() * 10 } and spell(divine_toll) or { holypower() == 0 or holypower() <= 2 and { spellcooldown(blade_of_justice) > gcd() * 2 or target.debuffpresent(execution_sentence) or target.debuffpresent(final_reckoning) } } and { not never(raid_event_adds_exists) or 600 > 20 } and { not hastalent(execution_sentence_talent) or spellcooldown(execution_sentence) > 15 } and { not hastalent(final_reckoning_talent) or spellcooldown(final_reckoning) > 15 } and spell(wake_of_ashes) or holypower() <= 4 and spell(hammer_of_wrath) or holypower() <= 3 and spell(blade_of_justice) or not target.debuffpresent(judgment_debuff) and { holypower() <= 2 or holypower() <= 4 and spellcooldown(blade_of_justice) > gcd() * 2 } and spell(judgment) or { target.healthpercent() <= 20 or buffpresent(avenging_wrath) or buffpresent(crusade) or buffpresent(empyrean_power_buff) } and retributionfinisherscdpostconditions() or spellcharges(crusader_strike count=0) >= 1.75 and { holypower() <= 2 or holypower() <= 3 and spellcooldown(blade_of_justice) > gcd() * 2 or holypower() == 4 and spellcooldown(blade_of_justice) > gcd() * 2 and spellcooldown(judgment) > gcd() * 2 } and spell(crusader_strike) or retributionfinisherscdpostconditions() or not buffpresent(consecration) and spell(consecration) or holypower() <= 4 and spell(crusader_strike) or holypower() <= 4 and spell(arcane_torrent) or retributiontimetohpg() > gcd() and spell(consecration)
}
...
AddFunction retributioncooldownsmainactions
{
 ...
 if { buffpresent(bloodlust) or buffpresent(avenging_wrath) and buffremaining(avenging_wrath) > 18 or buffpresent(crusade) and buffremaining(crusade) < 25 } and { checkboxon(opt_use_consumables) and target.classification(worldboss) } item(spectral_strength_item usable=1)
