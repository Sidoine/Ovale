...
export function registerHunterSpells(scripts: OvaleScriptsClass) {
    const name = "ovale_hunter_spells";
    const desc = "[9.1] Ovale: Hunter spells";
...
# Summons a flock of crows to attack your target, dealing 131900s1*16 Physical damage over 15 seconds. If the target dies while under attack, A Murder of Crows' cooldown is reset.
  ...
  SpellRequire(a_murder_of_crows unusable set=1 enabled=(not {hastalent(a_murder_of_crows_talent) or hastalent(a_murder_of_crows_talent_marksmanship) or hastalent(a_murder_of_crows_talent_survival)}))
...
# Summons a flock of crows to attack your target, dealing 131900s1*16 Physical damage over 15 seconds. If the target dies while under attack, A Murder of Crows' cooldown is reset.
Define(a_murder_of_crows_talent_marksmanship 22289)
# Summons a flock of crows to attack your target, dealing 131900s1*16 Physical damage over 15 seconds. If the target dies while under attack, A Murder of Crows' cooldown is reset.
Define(a_murder_of_crows_talent 22269)
# Summons a flock of crows to attack your target, dealing 131900s1*16 Physical damage over 15 seconds. If the target dies while under attack, A Murder of Crows' cooldown is reset.
