...
export function registerDruidSpells(scripts: OvaleScriptsClass) {
    const name = "ovale_druid_spells";
    const desc = "[9.1] Ovale: Druid baseline spells";
    // THIS PART OF THIS FILE IS AUTOMATICALLY GENERATED
    let code = `Define(adaptive_swarm_damage 325733)
# Command a swarm that heals 325748o1 or deals 325733o1 Shadow damage over 12 seconds to a target, and increases the effectiveness of your periodic effects on them by 325748s2.rnrnUpon expiration, finds a new target, preferring to alternate between friend and foe up to s1 times.
...
# Entering Eclipse increases your critical strike chance with Arcane or Nature spells by 339943s1*339943u, decreasing by 339943s1 every 339943t2 sec.
  SpellInfo(balance_of_all_things_arcane_buff duration=8 max_stacks=8 gcd=0 offgcd=1 tick=1)
...
# Entering Eclipse increases your critical strike chance with Arcane or Nature spells by 339943s1*339943u, decreasing by 339943s1 every 339943t2 sec.
  SpellInfo(balance_of_all_things_nature_buff duration=8 max_stacks=8 gcd=0 offgcd=1 tick=1)
...
# Go berserk for 15 seconds, reducing the cooldowns of Mangle, Thrash, Growl, and Frenzied Regeneration by s1 and the cost of Ironfur by s3.?a339062[rnrnGrants immunity to effects that cause loss of control of your character.][]
  ...
  # Cooldowns of Mangle, Thrash, Growl, and Frenzied Regeneration are reduced by w1. Ironfur cost reduced by w3.?w5>0[rnrnImmune to effects that cause loss of control of your character.][]
...
# Strikes all nearby enemies with a massive slash, inflicting s2 Physical damage. Deals reduced damage beyond s3 targets.rnrn|cFFFFFFFFAwards s1 combo lpoint:points;.|r
...
# An improved Bear Form that grants the benefits of Berserk, causes Mangle to hit up to (25 of Spell Power) targets, and increases maximum health by s5.?a339062[rnrnGrants immunity to effects that cause loss of control of your character.][]rnrnLasts 30 seconds. You may freely shapeshift in and out of this improved Bear Form for its duration.
  ...
  # Cooldowns of Mangle, Thrash, Growl, and Frenzied Regeneration are reduced by w1.rnIronfur cost reduced by w3.rnMangle hits up to w6 targets.rnHealth increased by w5.?w7>0[rnrnImmune to effects that cause loss of control of your character.][]
...
Define(kindred_empowerment_buff 327022)
# Energize your bonded partner, granting them 327139s1 of your damage as additional Arcane damage, healing, or absorption.
  SpellInfo(kindred_empowerment_buff duration=10 gcd=0 offgcd=1)
  # Energized by @auracaster, increasing damage, healing, and mitigation by s2 until Kindred Empowerment runs out.rnrnEmpowerment remaining: w1-1
  SpellAddBuff(kindred_empowerment_buff kindred_empowerment_buff add=1)
...
# Deals m1 Astral damage to the target and empowers New Moon to become Half Moon. rnrn|cFFFFFFFFGenerates m3/10 Astral Power.|r
  SpellInfo(new_moon cd=20 gcd=1 lunarpower=-10)
...
# Swipe all nearby enemies, inflicting s3 Physical damage. Deals reduced damage beyond s4 targets.?a231283[ Deals s2 increased damage against bleeding targets.][]rnrn|cFFFFFFFFAwards s1 combo lpoint:points;.|r
...
Define(thrill_seeker_buff 331939)
# While in combat, you gain a stack of Thrill Seeker every t1 sec, or s1 stacks on killing an enemy. At 331939u stacks Thrill Seeker is consumed to grant you Euphoria, increasing your Haste by 331937s1 for 10 seconds. Thrill Seeker decays rapidly while you are not in combat.
  SpellInfo(thrill_seeker_buff max_stacks=40 gcd=0 offgcd=1 tick=2)
  # At u stacks, you will gain Euphoria.
  SpellAddBuff(thrill_seeker_buff thrill_seeker_buff add=1)
...
SpellList(ca_inc_buff celestial_alignment incarnation_chosen_of_elune)
...
# The cooldown on Tiger's Fury resets when a target dies with one of your Bleed effects active, and Tiger's Fury lasts s1/1000 additional seconds.
...
# Finishing move that increases damage by 62071s1 and energy regeneration rate by (25 of Spell Power) while in Cat Form. Lasts longer per combo point:rnrn   1 point  : 12 secondsrn   2 points: 18 secondsrn   3 points: 24 secondsrn   4 points: 30 secondsrn   5 points: 36 seconds
Define(solstice_talent 21648)
# During the first 6 seconds of every Eclipse, Shooting Stars fall 343648s1 more often.
Define(soul_of_the_forest_talent_guardian 21709)
# Mangle generates m1/10 more Rage and deals s2 more damage.
Define(soul_of_the_forest_talent_feral 21708)
# Your finishing moves grant s1 Energy per combo point spent and deal s2 increased damage.
...
# Starfall deals s2 additional damage and allows you to cast while moving while it is active, but now has a s1/1000 sec cooldown.
Define(stellar_flare_talent 22165)
# Burns the target for (12.5 of Spell Power) Astral damage, and then an additional o2 damage over 24 seconds.rnrn|cFFFFFFFFGenerates m3/10 Astral Power.|r
Define(twin_moons_talent 22389)
...
Define(cateye_curio_runeforge 7089)
Define(draught_of_deep_focus_runeforge 7086)
...
Define(thrill_seeker_soulbind 331586)
