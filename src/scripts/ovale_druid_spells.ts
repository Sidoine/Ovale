...
Define(natures_balance_talent 1)
Define(new_moon_talent 21)
Define(photosynthesis_talent 19)
Define(predator_talent 2)
Define(prosperity_talent 2)
...
Define(shooting_stars_talent 19)
Define(soul_of_the_forest_talent 13)
Define(spring_blossoms_talent 18)
Define(starlord_talent 14)
Define(stellar_drift_talent 16)
Define(stellar_flare_talent 18)
Define(stonebark_talent 17)
