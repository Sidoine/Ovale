...
{
	const name = "sc_warrior_arms_t21"
	const desc = "[8.0] Simulationcraft: Warrior_Arms_T21"
	const code = `
...
{
	const name = "sc_warrior_fury_t21"
	const desc = "[8.0] Simulationcraft: Warrior_Fury_T21"
	const code = `
