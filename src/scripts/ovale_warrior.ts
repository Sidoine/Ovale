...
{
	const name = "sc_warrior_arms_pr"
	const desc = "[8.0] Simulationcraft: Warrior_Arms_PreRaid"
	const code = `
...
{
	const name = "sc_warrior_fury_pr"
	const desc = "[8.0] Simulationcraft: Warrior_Fury_PreRaid"
	const code = `
