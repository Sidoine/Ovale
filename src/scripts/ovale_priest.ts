...
{
	const name = "sc_priest_shadow_t19p_s2"
	const desc = "[7.0] Simulationcraft: Priest_Shadow_T19P_S2"
	const code = `
...
{
	const name = "sc_priest_shadow_t19"
	const desc = "[7.0] Simulationcraft: Priest_Shadow_T19"
	const code = `
