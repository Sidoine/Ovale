...
{
 buffexpires(moonkin_form) and spell(moonkin_form) or spell(wrath) or spell(wrath) or { not runeforge(balance_of_all_things_runeforge) or not iscovenant("night_fae") or not enemies() == 1 or not hastalent(natures_balance_talent) } and spell(starfire) or runeforge(balance_of_all_things_runeforge) and iscovenant("night_fae") and enemies() == 1 and buffexpires(starsurge_empowerment_lunar_buff) and spell(starsurge)
}
