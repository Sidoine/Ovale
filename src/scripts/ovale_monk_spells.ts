...
export function registerMonkSpells(scripts: OvaleScriptsClass) {
    const name = "ovale_monk_spells";
    const desc = "[9.1] Ovale: Monk spells";
...
Define(bob_and_weave_talent 20174)
    `;
    scripts.registerScript("MONK", undefined, name, desc, code, "include");
}
