...
{
	const name = "sc_monk_windwalker_pr"
	const desc = "[8.0] Simulationcraft: Monk_Windwalker_PreRaid"
	const code = `
...
{
    const name = "sc_monk_brewmaster_pr"
	const desc = "[8.0] Simulationcraft: Monk_Brewmaster_PreRaid"
	const code = `
