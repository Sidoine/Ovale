...
{
	const name = "sc_death_knight_frost_t19"
	const desc = "[7.0] Simulationcraft: Death_Knight_Frost_T19"
	const code = `
...
{
	const name = "sc_death_knight_unholy_t19"
	const desc = "[7.0] Simulationcraft: Death_Knight_Unholy_T19"
	const code = `
