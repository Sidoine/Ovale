...
AddFunction frostobliterationmainactions
{
 ...
 if buffpresent(killing_machine_frost) and enemies(tagged=1) >= 2 and { buffstacks(deaths_due_buff) == 8 or not buffpresent(death_and_decay) or not iscovenant("night_fae") } spell(frostscythe)
 ...
 if buffpresent(killing_machine_frost) or not buffpresent(rime_frost) and enemies(tagged=1) >= 3 spell(obliterate)
 ...
 if buffpresent(rime_frost) and enemies(tagged=1) >= 2 spell(howling_blast)
...
AddFunction frostbos_tickingmainactions
{
 ...
 if buffpresent(rime_frost) and { runicpowerdeficit() < 55 or timetorunes(3) <= gcd() or enemies(tagged=1) >= 2 } spell(howling_blast)
 ...
 if buffpresent(killing_machine_frost) and enemies(tagged=1) >= 2 and { not buffpresent(death_and_decay) and iscovenant("night_fae") or not iscovenant("night_fae") } spell(frostscythe)
...
AddFunction frostbos_poolingmainactions
{
 ...
 if buffpresent(killing_machine_frost) and runicpowerdeficit() > 15 + talentpoints(runic_attenuation_talent) * 3 and enemies(tagged=1) >= 2 and { buffstacks(deaths_due_buff) == 8 or not buffpresent(death_and_decay) or not iscovenant("night_fae") } spell(frostscythe)
...
AddFunction unholycooldownsshortcdactions
{
 ...
 if enemies() == 1 and target.debuffstacks(festering_wound) >= 4 and { not hastalent(unholy_blight_talent) or hastalent(army_of_the_damned_talent) and { not runeforge(deadliest_coil_runeforge) or conduitrank(convocation_of_the_dead_conduit) < 5 } or not hastalent(army_of_the_damned_talent) and conduitrank(convocation_of_the_dead_conduit) >= 5 or fightremains() < 16 } spell(apocalypse)
