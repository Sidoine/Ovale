...
if (locale == "deDE") {
    ...
    L["Cacher si cible amicale ou morte"] =
        "Ausblenden bei freundlichem oder totem Ziel";
...
So bald wie möglich benutzen oder für besondere Phasen aufheben.`;
    L[
        ...
        "Dieser Text wird auf dem Icon angezeigt, um anzuzeigen ob das Ziel in Reichweite ist";
    L["Click to select the script."] = "Anklicken, um das Skript auszuwählen";
    L["Cliquer pour afficher/cacher les options"] =
        "Klicken, um Optionen anzuzeigen/zu verbergen";
    L["Code"] = "Code";
    L["Colors"] = "Farben";
    ...
    L["Debug missing spells"] =
        "Warnen, wenn eine bekannte Spell-ID benutzt wird, die nicht im Zauberbuch vorhanden ist.";
    L["Debug unknown spells"] =
        "Warnen, wenn eine unbekannte Spell-ID im Skript verwendet wird.";
    ...
    L["Ecraser le Script personnalisé préexistant?"] =
        "Existierendes eigenes Skript überschreiben?";
    ...
    L[
        ...
        "Aufblitzende Zauber in der Aktionsleiste, wenn sie zur Nutzung bereit sind. Benötigt SpellFlashCore.";
    ...
    L["Illuminer l'icône quand la technique doit être spammée"] =
        "Icon hervorheben, wenn Fähigkeit gespammt werden sollte";
    L["Illuminer l'icône quand le temps de recharge est écoulé"] =
        "Icon blinken lassen, wenn die Fähigkeit bereit ist";
    ...
    L[
        ...
        "Verzögerung (in Millisekunden) zwischen Auslösen des Zaubers und dem Zeitpunkt, wenn der Effekt eintritt oder entfernt wird";
...
Benutzen, sobald sie bereit sind.`;
    ...
    L["The contents of a SimulationCraft profile."] =
        "Der Inhalt eines SimulationCraft-Profils.";
    L["The script translated from the SimulationCraft profile."] =
        "Das Skript aus dem SimulationCraft Profil übersetzt.";
    L[
        "Time (in milliseconds) to begin flashing the spell to use before it is ready."
    ] = "Zeit (ms) des Aufblitzens eines Zaubers, bevor er benutzbar ist.";
    ...
    L["Affiche le temps de recharge sous forme numérique"] =
        "Show the remaining time in numerical form";
    L["Affiche les deux prochains sorts et pas uniquement le suivant"] =
        "Display two abilities and not only one";
    L["Afficher la fenêtre"] = "Show Ovale";
    L[
        "Afficher les raccourcis clavier dans le coin inférieur gauche des icônes"
    ] = "Show keyboard shortcuts in the icon bottom-left corner";
...
Cast as soon as possible or for increased-damage phases.`;
    L[
        "Ce caractère est affiché dans un coin de l'icône pour indiquer si la cible est à portée"
    ] = "This text is displayed on the icon to show if the target is in range";
    L["Click to select the script."] = "Click to select the script.";
    L["Cliquer pour afficher/cacher les options"] =
        "Click to hide/show options";
    L["Code"] = "Code";
    L["Colors"] = "Colors";
    ...
    L["Debug missing spells"] =
        "Warn if a known spell ID is used that is missing from the spellbook.";
    L["Debug unknown spells"] =
        "Warn if an unknown spell ID is used in the script.";
    ...
    L["Illuminer l'icône quand la technique doit être spammée"] =
        "Hightlight icon when ability should be spammed";
    L["Illuminer l'icône quand le temps de recharge est écoulé"] =
        "Flash the icon when the ability is ready";
    L["Input"] = "Input";
    ...
    L["Middle-Click to toggle the script options panel."] =
        "Middle-Click to toggle the script options panel.";
    L["Modules"] = "Modules";
...
Cast alongside your main attack.`;
    ...
    L["Shift-Right-Click for the current trace log."] =
        "Shift-Right-Click for the current trace log.";
...
Cast as soon as possible.`;
    ...
    L["SIMULATIONCRAFT_OVERRIDES_DESCRIPTION"] =
        "Script code inserted immediately after Include() script statements to override standard definitions, e.g., |cFFFFFF00SpellInfo(tigers_fury tag=main)|r";
    ...
    L["Talents"] = "Talents";
    L["The contents of a SimulationCraft profile."] =
        "The contents of a SimulationCraft profile.";
    L["The script translated from the SimulationCraft profile."] =
    ...
    L["Affiche le temps de recharge sous forme numérique"] =
        "Ver tiempo restante de forma numérica";
    L["Affiche les deux prochains sorts et pas uniquement le suivant"] =
        "Mostrar dos habilidades y no solo una";
    L["Afficher la fenêtre"] = "Mostrar Ovale";
    L[
        "Afficher les raccourcis clavier dans le coin inférieur gauche des icônes"
    ] = "Mostrar atajo de teclado en la esquina inferior izquierda del icono";
...
Se adapta al número total de enemigos.`;
    ...
    L["Cacher si cible amicale ou morte"] =
        "Ocultar si el objetivo es aliado o está muerto";
...
Utilízalas lo antes posible para fases que requieran mucho daño.`;
    L[
        "Ce caractère est affiché dans un coin de l'icône pour indiquer si la cible est à portée"
    ] = "Este texto se muestra sobre el icono si el objetivo está a rango";
    L["Click to select the script."] = "Haz clic para seleccionar el script";
    L["Cliquer pour afficher/cacher les options"] =
        "Click para Ocultar/ver opciones";
    L["Code"] = "Código";
    L["Colors"] = "Colores";
    ...
    L["Debug missing spells"] =
        "Avisar si falta algún ID de hechizo del libro de hechizos.";
    L["Debug unknown spells"] =
        "Avisar si se utiliza algún ID de hechizo desconocido en el script.";
    L["Décalage horizontal des options"] =
        "Desplazamiento horizontal de las opciones";
    L["Décalage vertical des options"] =
        "Desplazamiento vertical de las opciones";
    L["Défilement"] = "rueda de desclazamiento";
    L["Disabled"] = "Desactivado";
    L["Ecraser le Script personnalisé préexistant?"] =
        "¿Deseas sobreescribir el script personalizado actual?";
    ...
    L[
        ...
        "Activar destello de hechizos en las barras de acción cuando éstos están listos para ser utilizados. Requiere SpellFleshCore";
    ...
    L["Illuminer l'icône quand la technique doit être spammée"] =
        "Iluminar el icono cuando la habilidad debe ser utilizada repetidamente";
    L["Illuminer l'icône quand le temps de recharge est écoulé"] =
        "Iluminar el icono cuando la habilidad esta lista";
    L["interrupt"] = "interrumpir";
    L["Interrupts"] = "interrupciones";
    L["Inverser la boîte à cocher "] =
        "Activar/desactivar la caja de selección";
    ...
    L[
        ...
        "Retraso (en milisegundos) entre el lanzamiento de un hechizo y el momento en que el aura correspondiente es aplicada";
    ...
    L["Right-Click for options."] =
        "Pulsar con el botón derecho para mostrar opciones";
    L["Script"] = "Script";
    ...
    L["SIMULATIONCRAFT_OVERRIDES_DESCRIPTION"] =
        "Utilizar el código insertado inmediatamente después de las sentencias Include() para forzar las definiciones estándar, p.e. |cFFFFFF00SpellInfo(tigers_fury tag=main)|r";
    ...
    L["The contents of a SimulationCraft profile."] =
        "Los contenidos del perfil de SimulationCraft";
    L["The script translated from the SimulationCraft profile."] =
        "El script traducido del perfil de SimulationCraft";
    L[
        "Time (in milliseconds) to begin flashing the spell to use before it is ready."
    ] =
        "Tiempo de antelación(en milisegundos) para que comience el destello de un hechizo antes de que esté listo";
...
Utilízalas lo antes posible o para fases que requieran mucho daño.`;
    L[
        "Ce caractère est affiché dans un coin de l'icône pour indiquer si la cible est à portée"
    ] = "Este texto se muestra sobre el icono si el objetivo está en el rango";
    L["Click to select the script."] = "Haz clic para seleccionar el script.";
    L["Cliquer pour afficher/cacher les options"] =
        "Click para ocultar/ver opciones";
    L["Code"] = "Código";
    ...
    L["Ecraser le Script personnalisé préexistant?"] =
        "¿Deseas sobrescribir el script personalizado actual?";
    L["En combat uniquement"] = "Mostrar sólo en combate";
    L["Flash brightness"] = "Brillo del destello";
    L["Flash size"] = "Tamaño del destello";
    ...
    L["Illuminer l'icône quand la technique doit être spammée"] =
        "Iluminar el icono cuando la habilidad debe ser utilizada repetidamente";
    L["Illuminer l'icône quand le temps de recharge est écoulé"] =
        "Iluminar el icono cuando la habilidad está lista";
    ...
    L[
        ...
        "Retraso (en milisegundos) entre el lanzamiento de un hechizo y el momento en que el aura correspondiente es aplicada o removida";
    L["Les icônes se déplacent"] = "Los iconos pueden desplazarse";
    L["Long cooldown abilities"] = "Cooldowns largos";
...
Lánzalas tan pronto sea posible.`;
    ...
    L["SimulationCraft Profile"] = "Perfil de SimulationCraft";
    L["SIMULATIONCRAFT_OVERRIDES_DESCRIPTION"] =
        "Utilizar el código insertado inmediatamente después de las sentencias Include() para forzar las definiciones estándar, ej: |cFFFFFF00SpellInfo(tigers_fury tag=main)|r";
    L["summon_pet"] = "Invocar mascota.";
    L["Taille des icônes"] = "Tamaño de los iconos";
    L["Taille des petites icônes"] = "Tamaño de los iconos pequeños";
    L["Taille des polices"] = "Tamaño del texto";
    L["Taille du second icône"] = "Tamaño del segundo icono";
    L["The contents of a SimulationCraft profile."] =
        "Contenidos del perfil de SimulationCraft";
    L["The script translated from the SimulationCraft profile."] =
        "Script traducido del perfil de SimulationCraft";
    L[
        "Time (in milliseconds) to begin flashing the spell to use before it is ready."
    ] =
        "Tiempo de antelación (en milisegundos) para que comience el destello de un hechizo antes de que esté listo";
...
Lancer dès que possible ou conserver pour les phases de dégâts amplifiés.`;
    ...
    L["Cliquer pour afficher/cacher les options"] =
        "Cliquer pour afficher/cacher les options";
    L["Code"] = "Code";
    L["Colors"] = "Couleurs";
    ...
    L["Debug missing spells"] =
        "Prévenir si le ID d'un sort qui n'est pas dans le livre de sorts est utilisé.";
    L["Debug unknown spells"] =
        "Prévenir si le ID d'un sort inconnu est utilisé dans le script.";
    ...
    L["Display refresh statistics"] =
        "Afficher les statistiques de rafraîchissement";
    L["Ecraser le Script personnalisé préexistant?"] =
        "Ecraser le Script personnalisé préexistant?";
    L["En combat uniquement"] = "En combat uniquement";
    L["Enable debugging messages for the %s module."] =
        "Activer les messages de debug pour le module %s";
    L["Enable profiling for the %s module."] =
        "Activer le profiling sur le module %s";
    L["Enabled"] = "Activé";
    ...
    L[
        ...
        "Illuminer les sorts des barres d'action quand ils sont prêts à être lancés. Requiert SpellFlashCore.";
    L["Flash threshold"] = "Tolérance pour le flash ";
    L["Focus"] = "Focus";
    L["Groupe d'icônes"] = "Groupe d'icônes";
    L["Horizontal offset"] = "Décalage horizontal";
    L["Horizontal offset from the center of the screen."] =
        "Décalage horizontal depuis le centre de l'écran";
    L["Icône"] = "Icône";
    ...
    L[
        ...
        "Latence (en milliseconde) quand un sort est lancé et qu'une aura est appliquée ou retirée.";
    ...
    L["Middle-Click to toggle the script options panel."] =
        "Clic milieu pour basculer l'affichage du panneau des options de script";
    L["Modules"] = "Modules";
...
Lancer en parallèle de l'attaque principale.`;
    L[
        ...
        "Ne compter un ennemi que s'il est directement affecté par un sort du joueur.";
    ...
    L["Open configuration panel in a separate, movable window."] =
        "Ouvrir le panneau de configuration dans une fenêtre séparée";
    L["Options"] = "Options";
    L["Output"] = "Sortie";
    L["Overrides"] = "Surcharges";
    L["Ping for Ovale users in group"] =
        "Vérifier la présence d'utilisateurs d'Ovale dans le groupe";
    L["Power"] = "Puissance";
    ...
    L["Reset the profiling statistics."] =
        "Réinitialiser les statistiques de profiling";
    ...
    L["Shift-Right-Click for the current trace log."] =
        "Maj-clic-droit pour les journaux de trace courants";
...
Lancer dès que possible.`;
    ...
    L["Show the profiling statistics."] =
        "Afficher les statistiques de profiling";
    ...
    L["SIMULATIONCRAFT_OVERRIDES_DESCRIPTION"] =
        "Code inséré immédiatement après les commandes Include() pour surcharger les définitions standard, par ex. |cFFFFFF00SpellInfo(tigers_fury tag=main)|r";
    ...
    L["Talents"] = "Talents";
    L["The contents of a SimulationCraft profile."] =
        "Le contenu d'un profil SimulationCraft";
    L["The script translated from the SimulationCraft profile."] =
        "Le script traduit d'un profil SimulationCraft";
    L[
        "Time (in milliseconds) to begin flashing the spell to use before it is ready."
    ] =
        "Temps (en millisecondes) avant de faire flasher le sort à utiliser quand il est prêt";
    L["Top 3"] = "Top 3";
    L["Trace"] = "Trace";
    ...
    L["Vertical offset from the center of the screen."] =
        "Décalage vertical depuis le centre de l'écran";
    L["Visibilité"] = "Visibilité";
} else if (locale == "itIT") {
    L["Affichage numérique"] = "Esposizione Numerica";
    L["Affiche le temps de recharge sous forme numérique"] =
        "Mostra il tempo rimanente in forma numerica";
    L["Affiche les deux prochains sorts et pas uniquement le suivant"] =
        "Espone due abilita' e non solo una";
    L["Afficher la fenêtre"] = "Mostra Ovale";
    L[
        "Afficher les raccourcis clavier dans le coin inférieur gauche des icônes"
    ] = "Mostra le scorciatoie da tastiera nell'icona in basso a sinistra";
    ...
    L["Cacher si cible amicale ou morte"] =
        "Nascondi se il bersaglio e' amico o morto";
...
Lanciare quando possibile o mantenere per moltiplicare i danni un specifiche fasi.`;
    L[
        ...
        "Questo testo e' mostrato sull'icona per mostrare se il bersaglio e' nel raggio d'azione";
    L["Click to select the script."] = "Clicca per selezionare lo script.";
    L["Cliquer pour afficher/cacher les options"] =
        "Premere per nascondere/mostrare le opzioni";
    L["Code"] = "Codice";
    ...
    L["Ecraser le Script personnalisé préexistant?"] =
        "Sovrascrivere lo script personalizzato esistente ?";
    ...
    L["Illuminer l'icône quand la technique doit être spammée"] =
        "Evidenzia icona quando l'abilita' dovrebbe essere spammata";
    L["Illuminer l'icône quand le temps de recharge est écoulé"] =
        "Illumina l'icona quando l'abilita' e' pronta";
    ...
    L[
        ...
        "Lag (in millisecondi) tra quando un incantesimo è lanciato e quando l'aura d'effetto è applicata o rimossa";
...
Cast alongside your Main Attack.`;
    ...
    L["Affiche le temps de recharge sous forme numérique"] =
        "Mostrar o tempo restante de forma numérica";
    L["Affiche les deux prochains sorts et pas uniquement le suivant"] =
        "Mostrar duas habilidades e não apenas uma";
    L["Afficher la fenêtre"] = "Mostrar Ovale";
    L[
        "Afficher les raccourcis clavier dans le coin inférieur gauche des icônes"
    ] = "Mostrar atalhos do teclado canto inferior esquerdo do ícone";
    ...
    L["Cacher si cible amicale ou morte"] =
        "Esconder se o alvo for amigável ou morto";
...
Use assim que possível ou espere por fases com dano maior.`;
    L[
        "Ce caractère est affiché dans un coin de l'icône pour indiquer si la cible est à portée"
    ] = "Este texto é mostrado no ícone para apontar se o alvo está no alcance";
    L["Cliquer pour afficher/cacher les options"] =
        "Clique para mostrar/esconder opções";
    L["Code"] = "Código";
    ...
    L["Illuminer l'icône quand la technique doit être spammée"] =
        "Iluminar ícone quando habilidade deverá ser spamada";
    L["Illuminer l'icône quand le temps de recharge est écoulé"] =
        "Iluminar ícone quando habilidade estiver pronta";
...
Use junto do seu Ataque Principal.`;
    ...
    L["Affiche le temps de recharge sous forme numérique"] =
        "Показать отсчет времени в цифровой форме";
    L["Affiche les deux prochains sorts et pas uniquement le suivant"] =
        "Показать две способности вместо одной";
    L["Afficher la fenêtre"] = "Показать Ovale";
    L[
        "Afficher les raccourcis clavier dans le coin inférieur gauche des icônes"
    ] = "Показывать сочетания клавиш в левом нижнем углу";
    L["aoe"] =
        "Атака нескольких противников. Адаптировано к полному количеству врагов.";
    ...
    L["Cacher si cible amicale ou morte"] =
        "Скрывать если союзник или цель мертва";
...
Использовать сразу, как только возможно или придерживать для фаз повышенного урона.`;
    L[
        "Ce caractère est affiché dans un coin de l'icône pour indiquer si la cible est à portée"
    ] = "Этот текст показывается на иконке если цель в радиусе досягаемости";
    L["Click to select the script."] = "Клик для выбора скрипта";
    L["Cliquer pour afficher/cacher les options"] =
        "Нажмите, чтобы скрыть/показать опции";
    L["Code"] = "Код";
    L["Copier sur Script personnalisé"] =
        "Скопировать в Пользовательский скрипт";
    ...
    L["Debug missing spells"] =
        "Предупреждать, если используется ID заклинания отсутствующего в книге заклинаний";
    L["Debug unknown spells"] =
        "Предупреждать о неизвестном ID заклинания в скрипте.";
    ...
    L["Ecraser le Script personnalisé préexistant?"] =
        "Перезаписать существующий Пользовательский скрипт?";
    ...
    L[
        ...
        "Подсвечивать способности, на панели умений, когда они готовы. Требуется SpellFlashCore";
    ...
    L["Illuminer l'icône quand la technique doit être spammée"] =
        'Подсвечивать иконки когда способность должна "спамиться"';
    L["Illuminer l'icône quand le temps de recharge est écoulé"] =
        "Мигать когда способность готова";
    ...
    L[
        ...
        "Задержка (в милисекундах) между произнесением заклинания и применением/пропаданием ауры";
...
`;
    L[
        ...
        "Считать мобов как врагов, только если они напрямую пострадали от способностей игрока.";
    ...
    L["Short cooldown abilities"] =
        "Способности с малым временем восстановления";
...
Используются так часто, как только возможно.`;
    ...
    L["SIMULATIONCRAFT_OVERRIDES_DESCRIPTION"] =
        "Код скрипта вставляется сразу после выражения Include() для перезаписи стандартных определений, например  |cFFFFFF00SpellInfo(tigers_fury tag=main)|r";
    ...
    L["The contents of a SimulationCraft profile."] =
        "Содержимре профайла SimulationCraft";
    L["The script translated from the SimulationCraft profile."] =
        "Преобразованный скрипт из профайла SimulationCraft";
    L[
        "Time (in milliseconds) to begin flashing the spell to use before it is ready."
    ] =
        "Время (в миллисекундах) за которое, до готовности, способность подсветится.";
...
卡CD使用或在boss增伤阶段使用。`;
    ...
    L[
        "Flash spells on action bars when they are ready to be cast. Requires SpellFlashCore"
    ] = "当技能冷却结束时显示闪光效果。需要插件SpellFLashCore";
...
盡快施放，或在爆發期使用。`;
    L[
        "Ce caractère est affiché dans un coin de l'icône pour indiquer si la cible est à portée"
    ] = "自訂一段文字，如果目標是在範圍內，這段文字會在圖示上顯示提醒你。";
    ...
    L[
        "Flash spells on action bars when they are ready to be cast. Requires SpellFlashCore"
    ] = "法術技能可以施放時，閃爍快捷列中的圖示。需要 SpellFlashCore 插件。";
...
儘快施放，或卡GCD、無招可放時使用。`;
    ...
    L["SIMULATIONCRAFT_OVERRIDES_DESCRIPTION"] =
        "緊接在 Include() 之後的程式碼會覆寫標準定義，例如 |cFFFFFF00SpellInfo(tigers_fury tag=main)|r";
    L["Spellbook"] = "法術書";
    L["Stances"] = "姿勢形態";
    ...
    L["Talents"] = "天賦";
    L["The contents of a SimulationCraft profile."] =
        "SimulationCraft 設定檔內容。";
    L["The script translated from the SimulationCraft profile."] =
        "依據 SimulationCraft 設定檔轉譯的腳本。";
    L[
        "Time (in milliseconds) to begin flashing the spell to use before it is ready."
    ] = "法術能夠使用前，多久開始閃爍 (毫秒)";
    L["Top 3"] = "Top 3";
