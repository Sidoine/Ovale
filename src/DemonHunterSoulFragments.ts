...
export class OvaleDemonHunterSoulFragmentsClass {
    ...
    private RequireSoulFragmentsHandler = (spellId: number, atTime: number, requirement: string, tokens: Tokens, index: number, targetGUID: string | undefined):[boolean, string, number] => {
        let verified = false;
